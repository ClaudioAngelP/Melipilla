<?php
    ...
    require_once('../../conectar_db.php');
      ...
      <td colspan=3><b>".$receta['receta_fecha']."</b> <i>ID: [".$receta['receta_id']."]</i></td></tr>
      <tr> 
      ...
      <td colspan=3>
      <b>".$receta['doc_rut']."</b> <i>".htmlentities($receta['doc_nombre'])."</i></td>
      </tr>
      <tr>
      ...
      for($a=0;$a<count($detalle);$a++) {
        ...
        /*if($receta['receta_cronica']=='f') {
          ...
          $recetahtml.="
          <td><i><b>".number_format($fila[8], 1,',','.')." ".$fila[14]."</b> cada 
          <b>".($fila[9]/$div_h)."</b> $txt_horas durante 
          <b>".($fila[10]/$div_d)."</b> $txt_dias</i></td>";
		...
		if($b) {
			...
			$recetahtml.='
			<tr class="'.$clase.'">
			<td style="text-align: right;font-weight:bold;">Atenci&oacute;n:</td><td colspan=4>
