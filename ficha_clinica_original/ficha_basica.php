...
<td>
    &nbsp;
    <img src='<?php echo $ruta; ?>iconos/zoom_in.png' id='buscar_paciente' onClick='busqueda_pacientes("paciente_rut", function() { verificar_rut(); });' onKeyUp="fix_bar(this);" alt='Buscar Paciente...' title='Buscar Paciente...'>
</td>
</tr>
</table></center>
</center>
...
<script>
    ...
    buscar_paciente = function()
    {
        ...
        var myAjax = new Ajax.Request('<?php echo $ruta; ?>registro.php', 
        {
            method: 'get', 
    ...
    listar_parientes = function(id_paciente, modo)
    {
        if(modo==0)
        {
            var myAjax = new Ajax.Updater('parentezco_div','<?php echo $ruta; ?>ficha_clinica/parientes.php', 
            {
                method: 'get', 
