...
<script>
    ...
    ver_sigges=function()
    {
        sigges = window.open('ficha_clinica/registro_sigges.php?rut='+encodeURIComponent($('paciente_rut').value)+'&pac_id='+encodeURIComponent($('paciente_id').value)+'&bod_id='+encodeURIComponent($('bodega_id').value),
                    ...
                    <div class='sub-content'> 
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="text-align:right;width:400px;">Acciones:<input type="button" value="Ingresar Paciente..." onClick="ingresar_paciente_nuevo();"></td>
                            </tr>
                        </table>
                    </div>
                    <div class='sub-content'>
