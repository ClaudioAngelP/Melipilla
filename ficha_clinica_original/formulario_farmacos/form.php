<?php 
	...
	$aut=cargar_registros_obj("
		SELECT * FROM autorizacion_farmacos WHERE autf_validar ORDER BY autf_nombre;
	");
...
listar_pacientes=function() {
	...
	var myAjax=new Ajax.Updater(
		'lista_pacientes',
		'ficha_clinica/formulario_farmacos/listar_pacientes.php',
		{
			method:'post',
...
guardar_paciente=function() {
	...
	var myAjax=new Ajax.Request(
		'ficha_clinica/formulario_farmacos/sql.php',
		{
			method:'post',
...
eliminar_paciente=function(pac_id) {
	...
	var myAjax=new Ajax.Request(
		'ficha_clinica/formulario_farmacos/sql_eliminar.php',
		{
			method:'post',
...
<div class='sub-content'><img src='iconos/pill.png' /> Formulario de Solicitud Autorizaci&oacute;n de F&aacute;rmacos</div>
