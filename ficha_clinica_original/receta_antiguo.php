 ...
 ?>
  		...
  		<script>
			...
			var myAjax=new Ajax.Request(
				'ficha_clinica/cargar_ultima_receta.php',
				{
					method:'post',
      ...
      comprobar_rut_adquiriente = function () {
        ...
        if(comprobar_rut(adq_rut_obj.value)) {
          ...
          var myAjax=new Ajax.Request(
			'ficha_clinica/datos_adquiriente.php',
			{
				method:'post',
...
?>
    ...
    <input type='hidden' id='centro_servicio' name='centro_servicio'>
    </td>
    </tr>
