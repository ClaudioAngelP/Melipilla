...
<script>
    ...
    __abrir_diag = function()
    {
        ...
        var myAjax = new Ajax.Request('recetas/ver_recetas/abrir_diagnostico.php',
        {
            method: 'get',
    ...
    {
        var myAjax = new Ajax.Request('recetas/editar_recetas/sql_borrar_receta.php',
        {
            method: 'get',
            parameters: 'receta_id=<?php echo $receta_id;?>',
            onComplete: function (respuesta)
            {
                try {
                    datos = respuesta.responseText.evalJSON(true);
                ...
                if(datos)
                {
                    alert('Eliminaci&oacute;n realizada exitosamente.'.unescapeHTML());
    ...
    {
        var myAjax = new Ajax.Request('recetas/editar_recetas/imprime_receta.php',
        {
            method: 'get',
    ...
    __guardar_receta = function()
    {
        ...
        var myAjax = new Ajax.Request('recetas/editar_recetas/sql.php',
        {
            method: 'get',
    ...
    __calcular_dif = function(id_recetad)
    {
        ...
        if(__inputs[1].value>24)
            __inputs[1].value=24;
        if(__inputs[1].value<1)
            __inputs[1].value=1;
    ...
    __cancelar_recetad = function(id_recetad)
    {
        __fila_recetad_act = document.getElementById('fila_recetad_'+id_recetad);
        __cols_act = __fila_recetad_act.getElementsByTagName('td');
        __cols_act[2].innerHTML=($('__cant_'+id_recetad).value*1);
        __cols_act[3].innerHTML=($('__horas_'+id_recetad).value*1);
        __cols_act[4].innerHTML=($('__dias_'+id_recetad).value*1);
    ...
    {
        var myAjax = new Ajax.Updater('__medicamentos','recetas/editar_recetas/mostrar_medicamentos.php',
        {
            method: 'get',
...
?>
        <table width=100%>
            <tr>
                <td style='text-align: right; font-style: italic; width:150px;'>Fecha de Emisi&oacute;n:</td>
                <td colspan=2>
                    <b><?php echo htmlentities($receta_a[0])?></b>
                </td>
            </tr>
            <tr>
                <td style='text-align: right; font-style: italic; width:150px;'>Tipo de Receta:</td>
                <td colspan=2>
            ...
            ?>
                <tr>
                    <td style='text-align: right; font-style: italic; width:150px;'>N&uacute;mero de Receta:</td>
                    <td colspan=2>
                        <b><?php echo htmlentities($receta_a[12])?></b>
                    </td>
                </tr>
            ...
            ?>
            <tr>
                <td style='text-align: right; font-style: italic;'>RUT Paciente:</td>
            ...
            <tr>
                <td style='text-align: right; font-style: italic;'>RUT M&eacute;dico:</td>
            ...
            <tr>
                <td style='text-align: right; font-style: italic;' valign='top'>C&oacute;digo Diag.:</td>
            ...
            <tr>
                <td style='text-align: right; font-style: italic;' valign='top'>Observaciones:</td>
                <td colspan=2>
...
?>
        <table width=100%>
            ...
            <tr>
                ...
                <td colspan=2>
                    <b><?php echo htmlentities($receta_a[11])?></b>
                    <?php echo htmlentities($receta_a[12])?>
                </td>
            </tr>
            <?php
            if($receta_a[10]!=0)
        ...
        <form id='__receta' name='__receta'>
            ...
            <table width=100%>
                <tr>
                    <td style='text-align: right; font-style: italic; width:150px;'>Fecha de Emisi&oacute;n:</td>
                    <td colspan=2>
                        <?php echo htmlentities($receta_a[0])?>
                    </td>
                </tr>
                <tr>
                    <td style='text-align: right; font-style: italic; width:150px;'>Tipo de Receta:</td>
                ...
                <tr>
                    <td style='text-align: right; font-style: italic;'>RUT Paciente:</td>
                    <td>
                        <input type='hidden' id='__id_paciente' name='__id_paciente' value=<?php echo $receta_a[8]?>>
                        <center>
                            <input type='text' id='__rut_paciente' name='__rut_paciente' size=10 style='text-align: center;' onChange='__abrir_paciente();' onKeyUp='if(event.which==13) __abrir_paciente(); ' value='<?php echo htmlentities($receta_a[1])?>'>
                            <img src='iconos/zoom_in.png' style='cursor: pointer;' onClick='buscar_pacientes("__rut_paciente", function() { __abrir_paciente(); });' alt='Buscar Paciente...' title='Buscar Paciente...'>
                        </center>
                    </td>
                    <td style='text-align: left;'>
                        <img src='imagenes/ajax-loader1.gif' id='__cargar_paciente' style='display: none;'>
                ...
                <tr>
                    ...
                    <td style='width:130px;'>
                        <center>
                            <input type='text' id='__rut_medico' name='__rut_medico' size=10 style='text-align: center;' onChange='__rut2nombre();' value='<?php echo htmlentities($receta_a[3])?>'>
                            <img src='iconos/zoom_in.png' alt='Buscar M&eacute;dico...' text='Buscar M&eacute;dico...'>
                        </center>
                    </td>
                    <td style='text-align: left;'>
                        <select id='__nombre_medico' name='__nombre_medico' onChange='__nombre2rut();'>
                ...
                <tr>
                    ...
                    <td valign='top'>
                        <center>
                            <input type='text' id='__codigo_diag' name='codigo_diag' size=5 style='text-align: center;' onChange='__abrir_diag();' value='<?php echo htmlentities($receta_a[4])?>'>
                            <input type='hidden' id='__id_diag' name='__id_diag' value='<?php echo htmlentities($receta_a[4])?>'>
                            <img src='iconos/zoom_in.png' style='cursor: pointer;' onClick='buscar_diagnosticos("__codigo_diag", function() { __abrir_diag(); } );' alt='Buscar Diagn&oacute;stico...' text='Buscar Diagn&oacute;stico...'>
                        </center>
                    </td>
                    <td style='text-align: left; font-weight: bold; font-style: italic; font-size: 12px;'>
                        <img src='imagenes/ajax-loader1.gif' id='__cargar_diag' style='display:none;'>
...
?>
        <tr>
            <td colspan=3>
                <div class='sub-content3' style='height: 180px; overflow: auto;' id='__medicamentos' name='__medicamentos'>
                </div>
            </td>
        </tr>
        <tr>
