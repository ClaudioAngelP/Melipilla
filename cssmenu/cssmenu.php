...
<span id="selecteditem" class="selecteditem">Selected</span>
    <ul>
        <li>Sesi&oacute;n de Usuario
            <ul>
                ...
                <li onclick="javascript:window.open('login.php', '_self', false);">Cerrar Sesi&oacute;n</li> 
            </ul>
        </li>
        <?php if( _cax(1)   OR _cax(2)  OR _cax(23) OR _cax(3)  OR _cax(4)  OR _cax(5)   OR _cax(6)  OR _cax(7)  OR _cax(23)  OR _cax(24) OR _cax(25) OR _cax(26) OR 
        _cax(27)  OR _cax(28) OR _cax(8)  OR _cax(9) OR _cax(41) OR _cax(60)  OR _cax(61) OR _cax(62) OR _cax(70) OR _cax(31) OR _cax(401) OR _cax(80)):?>
		<li>Farmacia/Bodega
        	<ul>
            ...
            <?php if(_cax(31)):?><li onclick="javascript:cambiar_pagina('abastecimiento/orden_compra/form.php');">&Oacute;rdenes de Compra</li>
	    <!---<li onclick="javascript:cambiar_pagina('abastecimiento/pago_cuentas/form.php');">Cuentas por Pagar</li>-->
            <?php endif;?>

	    <?php if(_cax(20000)):?>
		<li onclick="javascript:cambiar_pagina('abastecimiento/codificacion_masiva/form.php');">Codificaci&oacute;n Masiva O.C.</li>
	    <?php endif; ?>
            <?php if(_cax(30200)):?>
                <li onclick="javascript:cambiar_pagina('abastecimiento/articulos_farmacia/form.php');">Mantenedor Farmacia</li>
            <?php endif; ?>
            ...
            <?php if(_cax(25) OR _cax(44)):?>
            <?php if(_cax(25)):?>
            <li onclick="javascript:cambiar_pagina('abastecimiento/preparaciones/form.php');">Realizar Preparaciones</li>
            <!--<li onclick="javascript:cambiar_pagina('abastecimiento/preparaciones/form_consultas.php');">Trazabilidad Preparaciones</li>
            <li onclick="javascript:cambiar_pagina('recetas/receta_npt/form.php');">Recetario NPT</li>-->
            <?php endif;?>
			<?php if(_cax(25)):?>
	    <li onclick="javascript:cambiar_pagina('recetas/receta_npt/form.php');">Recetario NPT</li>
	    <li onclick="javascript:cambiar_pagina('recetas/receta_npt/form_consultar.php');">Consultas Receta NPT</li><?php endif;?>
            <?php endif;?>
	    <?php if(_cax(41)):?>
	    <li onclick="javascript:cambiar_pagina('recetas/receta_npt/form_consultar.php');">Recepci&oacute;n Recetas NPT</li>
	    <?php endif;?>
            <?php if((_cax(1) OR _cax(2) OR _cax(23) OR _cax(3)) AND _cax(4)):?><li class="menu-separator"></li><?php endif;?>
            <?php if(_cax(4)):?><li onclick="javascript:cambiar_pagina('abastecimiento/bincard_articulos/form.php');">Bincard de Art&iacute;culos</li><?php endif;?>
            <?php if(_cax(400)):?><li onclick="javascript:cambiar_pagina('abastecimiento/informe_rotacion/form.php');">Indice de Rotaci&oacute;n de Art&iacute;culos</li><?php endif;?>
            <?php if(_cax(401) OR _cax(80)):?>
                <li onclick="javascript:cambiar_pagina('abastecimiento/informe_recetas/form.php');">Total de Recetas y Preescripciones</li>
            <?php endif;?>
            <?php if(_cax(402)):?><li onclick="javascript:cambiar_pagina('abastecimiento/listado_selectivo/form.php');">Listado Conteo Selectivo</li><?php endif;?>
        ...
        <?php endif;?>
	 <?php if(_cax(38) OR _cax(39) OR _cax(40) OR _cax(51)):?>
        <li>Listas de Espera
        	<ul>
            	<?php if(_cax(39)):?>
        ...
        <?php endif;?>
        <?php if(_cax(250) OR _cax(251) OR _cax(252) OR _cax(253) OR _cax(254) OR _cax(255) OR _cax(256) OR _cax(257) OR _cax(258)):?>
        <li>Gesti&oacute;n de Camas
            <ul>
                ...
                <li class="menu-separator"></li>
                <?php endif;?>
                <?php if(_cax(251)):?><li onclick="javascript:cambiar_pagina('prestaciones/asignar_camas/form.php');">Asignaci&oacute;n de Camas</li><?php endif;?>
                ...
                <?php if(_cax(252)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/censo_pacientes/form.php');">Categorizaci&oacute;n de Pacientes</li>
                <?php endif;?>
                <?php if(_cax(252) OR _cax(258)):?>
                ...
                <?php if(_cax(252) OR _cax(258)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/asignar_camas/informe.php');">Informes Prestaciones</li>
                <?php endif;?>
               	<?php if(_cax(254)):?>
                <li class="menu-separator"></li>
        ...
        <?php if(_cax(49) OR _cax(50) OR _cax(200) OR _cax(201) OR _cax(202) OR _cax(300) OR _cax(203) OR
  				 _cax(204) OR _cax(205) OR _cax(206) OR _cax(207) OR _cax(208) OR _cax(209) OR _cax(301) OR _cax(302)
        ...
        <li>Prestaciones
            <ul>
                ...
                <li onclick="javascript:cambiar_pagina('prestaciones/ingreso_nominas/form_reagendar.php');">N&oacute;minas de Reagendamiento</li>
                <?php endif;?>
                <?php if(_cax(300)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/ingreso_nominas/form_sol_examenes.php');">N&oacute;minas de Solicitud de Ex&aacute;menes</li>
                <?php endif;?>
                <li class="menu-separator"></li>
                <?php if(_cax(208) OR _cax(209)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/ingreso_fap/form.php');">Registro de Prestaciones Quir&uacute;rgicas</li>
                <?php endif;?>
                <?php if(_cax(204)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/consultar_fap/form.php');">Informes Estad&iacute;sticos de FAP</li><?php endif;?>
                <?php if(_cax(204)):?>
                <li onclick="javascript:cambiar_pagina('prestaciones/ingreso_fap/buscar_fap.php');">Historial de Prestaciones Quir&uacute;rgicas</li><?php endif;?>
                <?php if(_cax(212)):?><li onclick="javascript:cambiar_pagina('prestaciones/consultar_fap/form_pabellon.php');">Informes Pabell&oacute;n</li><?php endif;?>
                <?php if(_cax(50)):?>
                <li class="menu-separator"></li>
        ...
        <?php endif;?>
         ...
         <?php if(_cax(321) OR _cax(329) OR _cax(327) OR _cax(330)):?>
        <li>Recaudaci&oacute;n
            <ul>
        <?php if(_cax(321)):?>
					<li onclick="javascript:cambiar_pagina('creditos/ingreso/form.php');">Recaudaci&oacute;n de Prestaciones</li>
					<li onclick="javascript:cambiar_pagina('creditos/ingreso/form.php?valorizar=1');">Valorizaci&oacute;n de Prestaciones</li>
					<li onclick="javascript:cambiar_pagina('ingresos/cierre_caja/form.php');">Informes de Caja</li>
					<li onclick="javascript:cambiar_pagina('ingresos/cierre_caja/form_cheques.php');">Registro de Cheques</li>
					<li class="menu-separator"></li>
					<li onclick="javascript:cambiar_pagina('creditos/busqueda/form.php');">B&uacute;squeda de Pacientes/Cr&eacute;ditos</li>
					<li onclick="javascript:cambiar_pagina('creditos/busqueda/form.php?morosidad=1');">Listado de Pacientes/Cr&eacute;ditos Morosos</li>
				<?php endif;?>
				<?php if(_cax(329) OR _cax(327) ):?>
					<li class="menu-separator"></li>
					<li onclick="javascript:cambiar_pagina('ingresos/mantenedor_recaudacion/form.php');">Mantenedor de Prestaciones</li>
				<?php endif;?>
				 <?php if(_cax(330)):?>
				 	<li onclick="javascript:cambiar_pagina('ingresos/pensionado_recaudacion/form.php');">Asociaci&oacute;n de Equipos M&eacute;dicos</li>
				 	<li onclick="javascript:cambiar_pagina('ingresos/devolucion_recaudacion/form.php');">Devoluci&oacute;n de Prestaciones</li>
					<li onclick="javascript:cambiar_pagina('ingresos/devolucion_recaudacion/form_ejecuta.php');">Ejecutar Devoluci&oacute;n</li>
					<li onclick="javascript:cambiar_pagina('ingresos/editar_num_boleta/form.php');">Edici&oacute;n de Boleta</li>
				<?php endif;?> 
			</ul>
        </li>
        <?php endif;?>
        <?php if(_cax(10002) OR _cax(20002) OR _cax(20003) OR _cax(20004) OR _cax(20001) OR _cax(20005)):?>
        <li>Archivo
            <ul>
		<?php if(_cax(10002)):?>
		  <li onclick="javascript:cambiar_pagina('prestaciones/archivo_fichas/form.php');">Picking Ficha</li>
		  <li onclick="javascript:cambiar_pagina('prestaciones/archivo_fichas/form_reportes.php');">Reportes</li>
		  <li onclick="javascript:cambiar_pagina('prestaciones/archivo_fichas/form_carga_masiva.php');">Carga Masiva N&oacute;minas</li>
		<?php endif;?>
                <?php if(_cax(20001) OR _cax(20005)):?>
		  <li onclick="javascript:cambiar_pagina('prestaciones/archivo_fichas/buzon_fichas/form.php');">Buzon Fichas</li>
		<?php endif;?>
		<?php if(_cax(20004)):?>
                  <!--<li onclick="javascript:cambiar_pagina('prestaciones/archivo_fichas/fusion_fichas/form.php');">Fusi&oacute;n de Fichas (en Levantamiento)</li>-->
		  <li onclick="javascript:cambiar_pagina('ficha_clinica/fusion_pacientes/form.php');">Fusi&oacute;n de Pacientes</li>
		<?php endif;?>
                <!--  
                <?php if(!_cax(42)):?><li onclick="javascript:cambiar_pagina('archivo/solicitud/form.php');">Crear Solicitudes de Fichas</li><?php endif;?>
                <?php if(_cax(43)):?><li onclick="javascript:cambiar_pagina('archivo/movimiento/form.php');">Salida de Fichas</li><?php endif;?>
                <?php if(_cax(321)):?><li onclick="javascript:cambiar_pagina('archivo/entradas/form.php');">Recepci&oacute;n de Fichas</li><?php endif;?>
        ...
        <li>Activo Fijo
        	<ul>
            	<?php if(_cax(100)):?><li onclick="javascript:cambiar_pagina('equipos/listado_usuario/form.php');">Listado de Inventario Asignado</li><?php endif;?>
                <?php if(_cax(102)):?><li onclick="javascript:cambiar_pagina('equipos/listado_mantencion/form.php');">Inventario Asignado Pendiente</li><?php endif;?>
                <?php if(_cax(103)):?><li onclick="javascript:cambiar_pagina('equipos/asignar_equipos/form.php');">Asignaci&oacute;n de Inventario en Mantenci&oacute;n</li><?php endif;?>
                <?php if(_cax(104)):?><li onclick="javascript:cambiar_pagina('equipos/ingreso_equipos/form.php');">Ingreso de Nuevo Inventario</li><?php endif;?>
                <?php if(_cax(105)):?><li onclick="javascript:cambiar_pagina('equipos/inventario_equipos/form.php');">Inventario de Activo Fijo</li><?php endif;?>
		<?php if(_cax(106)):?>
                <li onclick="javascript:cambiar_pagina('equipos/listado_mantencion/form.php?modo=admin');">Administrar Documentaci&oacute;n de Ordenes</li>
		<?php endif;?>
            </ul>
        </li>
        <?php endif;?>
        <?php if(_cax(205) OR _cax(206) OR _cax(207)):?>
        <li>Urgencia
            <ul>
                <li onclick="javascript:cambiar_pagina('prestaciones/urgencia/form.php');">Registro de Urgencia</li>
            </ul>
        </li>
        <?php endif;?>
	...
	OR _cax(303) OR _cax(304) OR _cax(305) OR _cax(502) OR _cax(503)):?>
        <li>Administraci&oacute;n
            <ul>
                ...
                <?php if(_cax(10003)):?><li onclick="javascript:cambiar_pagina('administracion/importar_stock/form.php');">Importar Inventario y Stock</li><?php endif;?>
                ...
                <?php if(_cax(40)):?><li onclick="javascript:cambiar_pagina('administracion/medicos/form.php');">Profesionales</li><?php endif;?>
		...
		<?php endif;?>-->
		<li onclick="javascript:cambiar_pagina('administracion/log_accesos/form.php');">Monitor Acceso Funcionarios</li>
            </ul>
        </li>
        <?php endif;?>
