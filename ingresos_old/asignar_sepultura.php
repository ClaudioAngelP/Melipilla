...
<html>
<title>Asignaci&oacute;n de Producto a Sepultura</title>
...
cargar_sep=function() {
	...
	'disponibilidad_sepultura.php',
	{
		...
		onComplete:function(resp) {
			...
			if(!r) {
				$('selsep').innerHTML='<br /><br /><br /><br /><b>Sepultura SIN ASIGNAR</b><br /><br /><input type="button" value="Asignar Producto a esta Sepultura..." onClick="asociar();" />';
			} else {
				$('selsep').innerHTML='<br /><br /><br /><br /><b>Sepultura ASIGNADA</b><br /><br /><input type="button" value="Asignar Producto a esta Sepultura..." onClick="asociar();" />';			
			}
		}
	});
...
<?php if($p_sel) { ?>
	...
	$('sel_clases').value='<?php echo $p_clase; ?>';
	...
	if($('sel_codigos').value!='<?php echo $p_codigo; ?>') {
		...
		$('sel_codigon').style.display='none';				
	}
