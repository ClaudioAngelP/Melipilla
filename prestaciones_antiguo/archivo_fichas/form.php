...
historial_ficha=function(pac_id) {
    ...
    pistolear_ficha = function ()
    {
			...
			var myAjax=new Ajax.Request(
				'prestaciones/archivo_fichas/sql_mover_ficha.php',
				{
					method:'post',
					parameters:$('barras').serialize()+'&'+$('info_nominas').serialize(),
					onComplete:function(r) {
...
<div class='sub-content' id='buscar_nominas'><center>
	...
	<tr><td style='text-align:right;'><img src='abastecimiento/hoja_cargo/barras.png' /></td>
		...
		style='font-size:18px;text-align:center;' onKeyUp='if(event.which==13) pistolear_ficha();' 
		...
		style='font-size:18px;text-align:left;border:none;' value='&lt;&lt; Seleccione Fichas con C&oacute;digo de Barras' />
