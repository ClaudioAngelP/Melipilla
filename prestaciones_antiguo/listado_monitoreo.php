...
<?php 
    ...
    for($i=0;$i<count($lista);$i++) {
	  ...
	  if($lista[$i]['mon_estado']!='t' OR $lista[$i]['mon_fecha_sigges']==''  OR $lista[$i]['mon_estado_sigges']=='Exceptuada')
		print("
      ...
      if(!$ver) {
			...
			if($lista[$i]['mon_estado']!='t' OR $lista[$i]['mon_estado_sigges']=='' OR $lista[$i]['mon_estado_sigges']=='Exceptuada') {
