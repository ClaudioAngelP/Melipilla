...
<?php 
	...
	for($i=0;$i<sizeof($c);$i++) {
		...
		if($pac_id==0)
		print("
		<td><center><img src='../../iconos/date_go.png' style='cursor:pointer;width:24px;height:24px;' onClick='abrir_nom(\"".$c[$i]['nom_folio']."\");' /></center></td>
		");
		else
		print("
		<td><center><img src='../../iconos/printer.png' style='cursor:pointer;width:24px;height:24px;' onClick='imprimir_citacion(".$c[$i]['nomd_id'].");' /></center></td>
		");
