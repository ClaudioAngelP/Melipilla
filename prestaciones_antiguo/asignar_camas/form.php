...
<script>
	...
	listado=function() {
		...
		var params=$('filtro').serialize()+'&'+$('busqueda').serialize()+'&'+$('tcamas').serialize()+'&'+$('esp_id').serialize();	
   ...
   visualizar_camas = function(id) {
    ...
    completa_info=function(hosp_id) {
	 ...
	 imprimir_deis=function(hosp_id) {
      ...
      window.open('prestaciones/ingreso_egreso_hospital/imprimir_egreso.php?hosp_id='+hosp_id, '_self');
