...
<input type='text' id='hosp_fecha_ing'  name='hosp_fecha_ing' style='text-align:center'
onBlur='validacion_fecha(this);' value='<?php echo $r[0]['hosp_fecha_ing']; ?>' onDblClick='' size='10'>
...
<input type='text' id='nombre_medico' name='nombre_medico' size=35
   ...
   <td style='text-align:right;'>Estado:</td>
	<td><select id='hest_id' name='hest_id' >
	<?php
