<?php
  ...
  $nro = pg_query($conn,
  "select receta_numero,(doc_nombres||' '||doc_paterno||' '||doc_materno) as doc_nombre,
...
<script>
      ...
      if($('motivo').value=='' || $('motivo').value.length<=5){
      	...
      	var myAjax = new Ajax.Request(
			'recetas/entregar_recetas/sql_cerrar_receta.php', 
			{
				method: 'get', 
		...
		<table width=100%;>
		<tr>
		<td style='text-align: right;'>N&uacute;mero Receta: </td><td style='text-align: left;'><b><?php echo $nro_receta ?></b></td>
		<td style='text-align: right;'>Fecha Emisi&oacute;n: </td><td style='text-align: left;'><b><?php echo $fecha_receta ?></b></td>
		</tr>
		<tr><td style='text-align: right;'>M&eacute;dico: </td><td style='text-align: left;' colspan=3><b><?php echo $doc_nombre ?></b></td></tr>
		<tr><td style='text-align: right;'>Paciente: </td><td style='text-align: left;' colspan=3><b><?php echo $pac_nombre ?></b></td></tr>
		</table>
		</div>
		<div class='sub-content'>
      ...
      <center><textarea id='motivo' name='motivo' cols=53 rows=2 ></textarea></center>
      </div>
