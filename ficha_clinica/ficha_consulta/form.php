...
<script>
	...
	$('paciente_materno').disabled=estado;
        $('paciente_pasaporte').disabled=estado;
        ...
        var myAjax = new Ajax.Request('registro.php', 
        {
            ...
            onComplete: function (pedido_datos)
            {
                ...
                else
                {
                    ...
                    $('paciente_pasaporte').value=datosxxx[19].unescapeHTML();
                    ...
                    $('pac_ficha').innerHTML=datosxxx[20];
                    //alert(datosxxx[20]);
	...
	var myAjax=new Ajax.Updater('lista_patologias','ficha_clinica/lista_patologias.php',
        {
            method: 'get',
            parameters: param,
            onComplete: function()
    ...
    listar_parientes = function(id_paciente, modo)
    {
        if(modo==0)
        {
            var myAjax = new Ajax.Updater('parentezco_div','ficha_clinica/parientes.php', 
            {
                method: 'get', 
	...
	$('paciente_tramo').disabled=false;
        $('paciente_editar').style.display='none';
	var myAjax = new Ajax.Request('ficha_clinica/ficha_consulta/sql.php', 
        {
            method: 'get', 
    ...
    {
        var win = new Window("mostrar_lotes", {className: "alphacube",top:40, left:0, 
    ...
    {
        var win = new Window("cerrar_receta", {className: "alphacube", top:40, left:0, 
    ...
    mostrar_recetas = function()
    {
        ...
        var myAjax0 = new Ajax.Updater('tab_recetas_content', 'recetas/entregar_recetas/recetario.php', 
        {
            method: 'get', 
    ...
    mostrar_historial = function()
    {
        ...
        var myAjax0 = new Ajax.Updater('tab_historial_content', 'recetas/entregar_recetas/historial_recetas.php', 
        {
            method: 'get', 
            parameters: 'tipo=recetario&paciente='+$('paciente_id').value+'&'+$('bodega_id').serialize(),
            evalScripts: true
    ...
    {
        window.open('prestaciones/consultar_web/carta_clave.php?rut='+encodeURIComponent($('pac_rut').value), '_blank');
    }
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="text-align:right;width:400px;">
                                    Acciones:<input type="button" value="Ingresar Paciente..." onClick="ingresar_paciente_nuevo();">
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class='sub-content'>
                        ...
                        <div class='sub-content'>
                            <table border=0 cellpadding=0 cellspacing=0>
                                <tr>
                                    <td>
                                        <b><span id='titulo_form'>B&uacute;squeda</span></b>
                                    </td>
                                </tr>
                            </table>
                            <table border=0 cellpadding=0 cellspacing=0>
                                <tr>
                                    <td style='font-weight: bold;'>
                                        <select id="paciente_tipo_id" name="paciente_tipo_id" style="font-size:10px;" onchange="">
                                    ...
                                    <td width=100>
                                        ...
                                        onKeyUp='if(event.which==13) { this.value=this.value.toUpperCase(); verificar_rut(); }' 
                                        onDblClick='limpiar_ficha_basica();' 
                                        maxlength=11>
                                    </td>
                                    <td onClick='busqueda_pacientes("paciente_rut", function() { verificar_rut(); });'>
                                        &nbsp;(<img src='iconos/zoom_in.png' id='buscar_paciente' onKeyUp="fix_bar(this);" alt='Buscar Paciente...' title='Buscar Paciente...'>B&uacute;squeda por nombre...)
                                    </td>
				</tr>
                            </table>
                        </div>
                        <div class='sub-content'>
                            <table>
                                <tr>
                                    ...
                                    <td><b>Ficha: <span id='pac_ficha' name='pac_ficha'></span></b></td>
                                ...
                                <tr>
                                    ...
                                    <td style='text-align:center;'>Pasaporte</td>
                                </tr>
                                <tr style='text-align: center;'>
                                    <td>
                                        <input type='text' style='text-align:center;' id='pac_rut' name='pac_rut' size='11' 
                                        onKeyUp='if(event.which==8 && this.value.length==0) $("paciente_rut").focus();' maxlength=100 class='form_campo'>
                                    </td>
                                    <td>
                                        <input type='text' id='paciente_nombre' name='paciente_nombre' size='22' 
                                        onKeyUp='if(event.which==8 && this.value.length==0) $("paciente_rut").focus();' maxlength=100 class='form_campo'>
                                    </td>
                                    <td>
                                        <input type='text' id='paciente_paterno' name='paciente_paterno' size='22' 
                                        onKeyUp='if(event.which==8 && this.value.length==0) $("paciente_nombre").focus();' maxlength=50 class='form_campo'>
                                    </td>
                                    <td>
                                        <input type='text' id='paciente_materno' name='paciente_materno' size='22' 
                                               accept=""onKeyUp='if(event.which==8 && this.value.length==0) $("paciente_paterno").focus();' maxlength=50 class='form_campo'>
                                    </td>
                                    <td>
                                        <input type='text' id='paciente_pasaporte' name='paciente_pasaporte' size='22' 
                                               accept=""onKeyUp='if(event.which==8 && this.value.length==0) $("paciente_materno").focus();' maxlength=50 class='form_campo'>
                                    </td>
                            ...
                            <tr>
                                <td>
                                    <div class='tabs' id='tab_ficha' style='cursor: default;' onClick='ver_ficha();'>
                                        <img src='iconos/report_user.png'>Informaci&oacute;n B&aacute;sica
                                    </div>
                                </td>
                                <td>
                                    <!--
                        ...
                        <div class='tabbed_content' id='tab_ficha_content'>
                            <center>
                                ...
                                <table width=100%>
                                    ...
                                    <tr style='text-align: center;'>
                                        <td style='text-align: center;'>
                                            <input type='text' id='paciente_fecha' name='paciente_fecha' style='text-align: center;' onBlur='calcular_edad();' class='form_campo'>
                                        </td>
                                        <td valign='top'>
                                    ...
                                    <tr style='text-align: center;'>
                                        ...
                                        <td>
                                            <select id='paciente_prevision' name='paciente_prevision' class='form_campo' onClick='actualizar_cod_prev();' style='text-align: center;'>
                                    ...
                                    <tr style='text-align: center;'>
                                        <td>
                                            <input type='text' id='paciente_mail' name='paciente_mail'  maxlength=100 class='form_campo' size=25 onBlur='valida_email(this.value);'>
                                        </td>
                                        <td>
                                            <input type='text' class='form_campo' name='paciente_fono' id='paciente_fono' maxlength=60>
                                        </td>
                                        <td>
                                            <input type='text' class='form_campo' name='paciente_celu' id='paciente_celu' maxlength=60>
                                        </td>
                                    </tr>
                                </table>
                                <table>
                                    ...
                                    <tr style='text-align: center;'>
                                        ...
                                        <td>
                                            <input type='text' class='form_campo' name='paciente_sector' id='paciente_sector' maxlength=80>
                                        </td>
                                        <td>
                                ...
                                <select id='paciente_prevision' name='paciente_prevision' onClick='actualizar_cod_prev();' style='display:none;'>
                                    <?php echo $previsionhtml; ?>
                                </select>
                        ...
                        <div class='tabbed_content' id='tab_refs_content' style='display: none;'>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' size=70 maxlength=200 id='paciente_padre' name='paciente_padre'>
                                    </td>
                                </tr>
                                <tr>
