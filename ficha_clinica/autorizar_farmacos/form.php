<?php
    ...
    $aut=cargar_registros_obj("SELECT * FROM autorizacion_farmacos WHERE autf_id IN ("._cav(502).","._cav(503).") ORDER BY autf_nombre;");
?>
<script>
    ...
    {
        var myAjax=new Ajax.Updater('lista_pacientes',
    ...
    {
        var myAjax=new Ajax.Request('ficha_clinica/autorizar_farmacos/sql.php',
        {
            method:'post',
	...
	if(!conf)
        ...
        var myAjax=new Ajax.Request('ficha_clinica/autorizar_farmacos/sql_eliminar.php',
        {
            method:'post',
            ...
            <div class='sub-content'>
                <table style='width:100%;'>
                    ...
                    <tr>
                        ...
                        <td class='tabla_fila2' colspan=2 style='text-align:center;width:40%;' id='pac_edad'>Edad:<b>?</b></td>
                    </tr>
                    <tr>
