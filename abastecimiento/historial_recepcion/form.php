...
<script>
    ...
    abrir_movimiento= function(id_log)
    {
        ...
        <tr>
            <td>
                <div class="sub-content">
                    ...
                    <form id='filtro_pedidos' onChange='cargar_recepciones();' onSubmit='return false;'>
                        <div class="sub-content">
                            <table width=100%>
                                <tr>
                                    ...
                                    <td>
                                        <select name='tipo_mov' id='tipo_mov'>
                                            ...
                                            <option value=5>
                                                Ingreso por Donaci&oacute;n
                                            </option>
                                            <option value=6>
                                                Pr&eacute;stamo/Devoluci&oacute;n
                                            </option>
                                            <option value=7>
                                                Baja por Vencimiento
                                            </option>
                                            <option value=8>
                                                Baja de Art&iacute;culos
                                            </option>
                                            <option value=16>
                                                Devoluci&oacute;n desde Servicios
                                            </option>
                                            <option value=20>
                                                Inicio de Control por Sistema
                                            </option>
					    <option value=30>
						Ajustes de Saldos
					    </option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name='bodega_origen' id='bodega_origen'>
                                            ...
                                            <option value='-2'>
                                                (Todas las Bodegas de Abastecimiento...)
                                            </option>
                                ...
                                <tr>
                                    ...
                                    <td colspan=3>
                                        ...
                                        <input type='text' id='_prov_id' name='_prov_id' onKeyUp='if(event.which==13)cargar_recepciones();' onDblClick='liberar_proveedor();' size=15>
                                ...
                                <tr>
                                    <td style='text-align: right;'>
                                        N&uacute;mero de O.C.:
                                    </td>
                                    <td colspan=3>
                                        <input type='text' id='nro_orden' name='nro_orden' size=25 />
                                    </td>
