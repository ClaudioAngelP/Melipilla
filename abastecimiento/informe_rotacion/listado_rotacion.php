<?php
	...
	$inicial=pg_query("
		...
		JOIN logs ON log_fecha <= '$fecha1 23:59:59' AND stock_log_id=log_id
	...
	$salidas=pg_query("
		...
		JOIN logs ON log_fecha >= '$fecha1 00:00:00' AND log_fecha <= '$fecha2 23:59:59' AND
	...
	$mov=pg_query("
		...
		JOIN logs ON log_fecha >= '$fecha1 00:00:00' AND log_fecha <= '$fecha2 23:59:59' AND stock_log_id=log_id
		LEFT JOIN pedido ON log_id_pedido=pedido_id
		LEFT JOIN pedido_log_rev USING (log_id)
		JOIN articulo_bodega ON (artb_art_id=stock_art_id AND artb_bod_id=stock_bod_id)
