...
<script>
    ...
    redibujar = function() {
      ...
      //for(var i=0;i<articulos.length;i++) {
      for(var i=articulos.length-1;i>=0;i--) { //ultimo en agregar es primero de la lista
    ...
    ingresar_ajuste = function () {
      ...
      if($('carga_masiva').value=='-- Generar Ajuste Manual... --') {
		  ...
		  window.open('', 'ajuste', 'width=600, height=450, left=100, top=100');
...
enctype="multipart/form-data" method='post' action='abastecimiento/ajustar_stock/sql_carga_masiva.php'
