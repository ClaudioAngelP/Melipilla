...
chequear_todo = function(valor) {
    ...
    descargar_pedido = function() {
      ...
      if(!bloquear_descarga) {
        ...
        'abastecimiento/recepcion_pedido/bajar_pedidos.php',
        {
          method: 'get',
...
var bloquear_ingreso=false;
  ...
  aceptar_pedido = function (accion) {
    ...
    'abastecimiento/recepcion_pedido/sql.php',
    {
      method: 'post',
	...
	resp=respuesta.responseText.evalJSON(true);
          ...
          if(resp[0]=='OK') {  
            ...
            /*recep = window.open('abastecimiento/recepcion_pedido/generar_pdf.php?id_log='+resp[1], 'ver_recepcion',
						'scrollbars=yes, toolbar=no, left='+l+', top='+t+', '+'resizable=no, width=800, height=715');*/
						
			recep = window.open('abastecimiento/recepcion_pedido/ver_recepcion.php?id_log='+resp[1], 'ver_recepcion',
						'scrollbars=yes, toolbar=no, left='+l+', top='+t+', '+'resizable=no, width=800, height=715');
...
<input type='text' style='text-align: right;' onChange='descargar_pedido();'
id='numero_pedido' name='numero_pedido' size=8>
<img src='iconos/zoom_in.png' style='cursor: pointer;'
onClick='listar_pedidos();'>
...
<b>Detalle del Pedido</b> ( <input type="checkbox" id="check_all" name="check_all" onClick="chequear_todo(this.checked);"> Aceptar todos los Art&iacute;culos / <input type="checkbox" id="check_end" name="check_end" onClick=""> Terminar Pedido)
</div>
<div class='sub-content2' id='detalle_pedido'>



<table style="width:100%;"><tr class="tabla_header">
<td style="width:100px;" rowspan=2><b>Cod. Interno</td><td style="width:200px;" rowspan=2><b>Glosa</td><td colspan=4><b>Cantidades</b></td><td rowspan=2><b>Aceptar</b></td></tr><tr class="tabla_header"><td><b>Solicitada</b></td><td><b>Enviada</b></td><td><b>Diferencia</b></td></tr></table>
...
<div class='sub-content' style='display: none;' id='boton_aceptar'>
  ...
  <div class='boton'>
	  <table><tr><td>
		...
		<a href='#' onClick='aceptar_pedido(0);'>
    Confirmar Pedido...
    </a>
		</td></tr></table>
  ...
  <div class='boton'>
		...
		<a href='#' onClick='aceptar_pedido(1);'> 
    Rechazar Pedido...</a>
		</td></tr></table>
		</div>
