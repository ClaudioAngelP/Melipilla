...
<?php echo $sghservicio; ?><br />
<?php echo $sghinstitucion; ?><br />
...
<input type='hidden' name='corr' id='corr' value='<?php echo $listado['ls_id'] ?>'>
 </div>
 <div style='width:100%;text-align:left;font-size:14px;'>
FUNCIONARIO: <u><?php echo $listado['func_nombre']; ?></u>
</div>
		...
		print("<tr class='$clase'>
				...
				//resultado diferencias
					print("<td style='width:15%;text-align:center;'>".$detalle[$i]['lsd_stock']."</td>
						...
						<td>\$ ".number_formats(str_replace('-','',$detalle[$i]['valor'])).".-</td>
						<td>\$ ".number_formats(str_replace('-','',($detalle[$i]['valor']*1.19))).".-</td>
						");
				}
				print("</tr>");	
