<?php
  ...
  $arts = pg_query($conn, $query);
    ...
    print('
    <form id="pedido_pedido_total_form" name="pedido_pedido_total_form" 
    onSubmit="return false;"
    action="abastecimiento/stock_articulos/generar_pedidos.php" method="post">
    <input type="hidden" id="pedido_bodega_t" name="pedido_bodega" 
    value="'.$bodega.'"> 
    <input type="hidden" id="pedido_nro_arts_t" name="pedido_nro_arts"
