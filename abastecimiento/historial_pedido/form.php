        ...
        <tr>
            <td>
                <div class='sub-content'>
                    ...
                    <div class='sub-content'>
                        <form id='filtro_pedidos' name='filtro_pedidos' onSubmit='return false;'>
                            <input type='hidden' id='art_id' name='art_id' value='0'>
                            <table width=100%>
                                <tr>
                                    <td style='text-align: right;'>Or&iacute;gen:</td>
                                    <td colspan=2>
                                        <select name='bodega_origen' id='bodega_origen' onChange='cargar_pedidos();'>
                                    ...
                                    <td colspan=3>
                                        <input type='text' name='fecha1' id='fecha1' size=10 style='text-align: center;' onChange='cargar_pedidos();' value='<?php echo $fecha1?>'>
                                ...
                                <tr>
                                    ...
                                    <td colspan=2>
                                        <select name='bodega_destino' id='bodega_destino' onChange='cargar_pedidos();'>
                                    ...
                                    <td colspan=3>
                                        <input type='text' name='fecha2' id='fecha2' size=10 style='text-align: center;' onChange='cargar_pedidos();' value='<?php echo $fecha2?>'>
                                        <img src='iconos/date_magnify.png' id='fecha2_boton'>
                                    </td>
                                </tr>
                                <tr>
                                    <td style='text-align: right;'>Codigo Articulo:</td>
                                    <td colspan=7>
                                        <table>
                                            <tr>
                                                <td>
                                                    <input type='text' name='codigo' id='codigo' onDblClick='limpiar_articulo();'  size=17>
                                                </td>
                                                <td id="td_glosa_art">&nbsp;</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan=2>
                                        <select id='orden' name='orden' onChange='cargar_pedidos();'>
                                            <option value=0>Fecha/Hora</option>
                                            <option value=1>N&uacute;mero de Pedido</option>
                                        </select>
                                        <input type='checkbox' id='orientacion' name='orientacion' onChange='cargar_pedidos();'> Ascendente
                                    </td>
                                    <td style='text-align: right;'>
                                        <input type='checkbox' id='pds_propios' name='pds_propios' onChange='cargar_pedidos();' onClick=''>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan=2>
                                        <select id='estado' name='estado' onChange='cargar_pedidos();'>
                                        ...
                                        &nbsp;
                                        N&deg; Pedido:&nbsp; <input type='text' name='nro_pedido' id='nro_pedido' onChange='cargar_pedidos();' size='6'>
                                    </td>
                                    <td style='text-align: right;'>N&deg; de Pedidos:</td>
                                    <td>
                                        <input type='text' name='total_pds' id='total_pds' disabled size='3' style='font-size:11px;text-align: center;'>
                                    </td>
                                    <td>
                                        <center>
                                            <div class='boton'>
                    ...
                    <div class='sub-content2' id='listado_pedidos' style='overflow: auto; height: 300px;'>
                    </div>
  ...
  abrir_articulo = function(d)
    ...
    autocompletar_medicamentos = new AutoComplete(
      ...
      function() {
        ...
        return {
          method: 'get',
          parameters: 'tipo=buscar_arts&codigo='+encodeURIComponent($('codigo').value)
        }
