<?php
    ...
    $destino_id,
    $origen_id,
    'Creado junto con traslado de artículos asociado.',
    $estado_pedido,
    true
    )
    ");
    ...
    // Operaciones Específicas x Movimiento
    ///////////////////////////////////////
    ...
    for($i=0;$i<=$cantidad_mov;$i++) {
        ...
        ");
				...
				// a la opción de movimiento seleccionada...
        ...
        ");
				...
				// serán movidos... Un movimiento por cada lote diferente.
				...
				while($cant>0) {
				  ...
				  if($bloquea==300) {
					...
					// Excepto en movimientos de préstamos externos y
            ...
            if($tipomov==0 or $tipomov==7)
            {
                if(comprobar_talonario($id_articulo))
                {
                    ...
                    for($t=0;$t<=count($tals);$t++)
                    {
                        ...
                        // $taldetalle[1] = ID del funcionario/médico
		...
		// Movimiento para Ingreso por Excedente/Donación
		// Movimiento para Entrada vía Préstamo
		/////////////////////////////////////////////////
        ...
        $id_articulo = ($_POST['id_art_'.$i]*1);
          ...
          $vencimiento = "'".pg_escape_string($_POST['fecha_art_'.$i])."'";
				...
				// Aumenta en la ubicacion de orígen.
    ...
    // Movimiento para Salida vía Préstamo
    //////////////////////////////////////
    ...
    */
    ...
    // Retorna el id del pedido recién creado en caso de ser necesario.
    // Traslados, Préstamos, Despachos siempre tienen un pedido
    // asociado.
