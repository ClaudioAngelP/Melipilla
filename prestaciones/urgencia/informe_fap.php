<?php
  ...
  $lista = cargar_registros_obj("
		...
		WHERE fap_fecha::date BETWEEN '$fecha1' AND '$fecha2'
...
<td>A&ntilde;os</td><td>Meses</td><td>D&iacute;as</td>
<td>Sexo</td>
<!-- EGF-->
<td>Prevision</td>
<!-- EGF-->
...
<?php 
  ...
  for($i=0;$i<count($lista);$i++) {
    ...
    print("<td style='text-align:center;'>".$lista[$i]['pac_rut']."</td>");
	 ...
	 print("<td style='text-align:center;'>".$fap['edad_anios']."</td>");
	 print("<td style='text-align:center;'>".$fap['edad_meses']."</td>");
	 print("<td style='text-align:center;'>".$fap['edad_dias']."</td>");
		
	 print("<td style='text-align:left;'>".$sexo."</td>");	
         print("<td style='text-align:left;'>".$lista[$i]['prev_desc']."</td>");	//EGF
