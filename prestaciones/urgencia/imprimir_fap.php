<?php
	...
	$pdf->Cell(190,4,'Serv. de Salud Viña del Mar - Quillota',0,1,'L');
	...
	$pdf->Cell(47,8,'Modo de Atención:',1,0,'R');
	$pdf->SetFont('Arial','', 10);
	$pdf->Cell(78,8,$fap['fap_subtipopab'],1,0,'L');
	$pdf->SetFont('Arial','', 12);


	$pdf->Cell(27,8,'Ficha Clínica:',1,0,'R');
	...
	if (trim($fap['fap_tipopab']) == "") {
		...
		$pdf->Cell(47,8,'Tipo Atención (I.Q.):',1,0,'R');
		$pdf->SetFont('Arial','', 12);
		$pdf->Cell(141,8,$subtipo1,1,1,'L');
	...
	$pdf->Cell(47,8,'Servicio Orígen:',1,0,'R');
	$pdf->Cell(78,8,cut($fap['centro_nombre'],25),1,0,'L');
	$pdf->Cell(27,8,'Previsión:',1,0,'R');
    ...
    $pdf->Cell(27,7,'N° Pabellón:',1,0,'R');
	$pdf->Cell(36,7,$fap['fapp_desc'],1,1,'L');

	$pdf->Cell(47,7,'Suspensión de FAP:',1,0,'R');
	...
	$pdf->Cell(188,8,'DIAGNÓSTICOS PRE./POST. OPERATORIOS',1,1,'C');
	$pdf->SetFont('Arial','', 12);
    ...
    /* EGF */
        ...
        $pdf->Cell(35,8,'Eval. Pre. Anestésica:',1,0,'R');
...
//	$pdf->Ln();
//        $pdf->Cell(38,7,'Observación:',1,0,'R');
