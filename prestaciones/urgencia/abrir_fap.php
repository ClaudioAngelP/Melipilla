<?php
    ...
    $presta=cargar_registros_obj("SELECT * FROM fap_prestacion 
	...
	$destinohtml = desplegar_opciones("fap_destino", "fapd_id, fapd_desc",$fap[0]['fap_destino'],'true','ORDER BY fapd_id'); 
        ...
        $pabellonhtml = desplegar_opciones("fappab_pabellones", "fapp_id, fapp_desc",$fap[0]['fap_numpabellon'],'true','ORDER BY fapp_id'); 
	...
	$html.='<option value="C1" '.($val==1?'SELECTED':'').'>C1</option>';	
	$html.='<option value="C2" '.($val==2?'SELECTED':'').'>C2</option>';	
	$html.='<option value="C3" '.($val==3?'SELECTED':'').'>C3</option>';	
	$html.='<option value="C4" '.($val==4?'SELECTED':'').'>C4</option>';	
	$html.='<option value="C5" '.($val==5?'SELECTED':'').'>C5</option>';
        return $html;
    }
    ...
    <tr>
        <td style='width:50%;'>
            <table style='width:100%;' cellpadding=1 cellspacing=1>
                ...
                <?php if($tipof!=5) { ?>
                <tr>
                    <td class='tabla_fila2'  style='text-align:right;'>DAU Nro.:</td>
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        ...
                        <input type='text' size=10 id='pac_rut' name='pac_rut' value='<?php echo $fap[0]['pac_rut']; ?>' />
                    </td>
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <select id='fap_tipopab' name='fap_tipopab' onChange='if(this.value==0) {$("sel_tabla").style.display="";} else {$("sel_tabla").style.display="none";}'>
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <select  style='font-size:11px;' id='sex_id' name='sex_id'>
                            <?php echo $sexohtml; ?>
                        </select>
                    </td>
                    <td class='tabla_fila2'  style='text-align:right;'>Hora NSP:</td>
                    <td class='tabla_fila'>
                        <input type='text' id='fap_hora_nsp' name='fap_hora_nsp' size=3 onBlur='validar_hora(this);' value='<?php echo substr($fap[0]['fap_hora_nsp'],0,5); ?>' />
                    </td>
                </tr>
                <tr>
                    <td class='tabla_fila2'  style='text-align:right;'>Comuna:</td>
                    <td class='tabla_fila' colspan=3>
                        <select  style='font-size:11px;' id='ciud_id' name='ciud_id'>
                            <?php echo $comunahtml; ?>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class='tabla_fila2'  style='text-align:right;'>Previsi&oacute;n:</td>
                    <td class='tabla_fila' colspan=3>
                        <select style='font-size:11px;' id='prev_id' name='prev_id'>
                ...
                <tr>
                    ...
                    <td class='tabla_fila' colspan=3>
                        <input type='text' id='diag_cod' name='diag_cod' size=8 value='<?php echo $fap[0]['fap_diag_cod']; ?>' />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class='tabla_fila' colspan=2>
                        <input type='text' id='diag_cod' name='diag_cod' size=20 value='<?php echo $fap[0]['fap_diag_cod']; ?>' />
                    </td>
                ...
                <tr>
                    ...
                    <td class='tabla_fila' colspan=3>
                        <input type='text' id='fap_diag_cod_<?php echo $i; ?>' name='fap_diag_cod_<?php echo $i; ?>' value='<?php echo $fap[0]['fap_diag_cod_'.$i]; ?>' DISABLED size=5 style='font-weight:bold;text-align:center;' />
                        <input type='text' id='fap_diagnostico_<?php echo $i; ?>' name='fap_diagnostico_<?php echo $i; ?>' value='<?php echo htmlentities($fap[0]['fap_diagnostico_'.$i]); ?>' onDblClick='this.value=""; $("fap_diag_cod_<?php echo $i; ?>").value="";' size=35>
                    </td>
                </tr>
                <?php 
                }
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input type='text' id='fap_hora_atencion' name='fap_hora_atencion' onBlur='validar_hora(this);' value='<?php echo substr($fap[0]['fap_hora_atencion'],0,5); ?>' size=3 />
                    </td>
                    <td class='tabla_fila2'  style='text-align:right;'>Hora Alta:</td>
                    <td class='tabla_fila'>
                        <input type='text' id='fap_hora_alta' name='fap_hora_alta' onBlur='validar_hora(this);' value='<?php echo substr($fap[0]['fap_hora_alta'],0,5); ?>' size=3 />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class='tabla_fila' colspan=3>
                        <input type='text' id='rut_medico' name='rut_medico' size=8 style='text-align: center;font-size:11px;' value='<?php echo $fap[0]['doc_rut']; ?>' DISABLED>
                    </td>
                </tr>
                <tr>
                    <td class='tabla_fila2'  style='text-align:right;'>Nombre M&eacute;dico:</td>
                    <td class='tabla_fila' colspan=3>
                        <input type='hidden' id='fap_doc_id' name='fap_doc_id' value='<?php echo $fap[0]['fap_doc_id']; ?>' /> 
                        <input type='text' id='nombre_medico' name='nombre_medico' style='font-size:11px;' size=25 value='<?php echo htmlentities(trim($fap[0]['doc_paterno'].' '.$fap[0]['doc_materno'].' '.$fap[0]['doc_nombres'])); ?>'>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input type='checkbox' id='fap_ges' name='fap_ges' <?php if($fap[0]['fap_ges']=='t') echo 'CHECKED'; ?> 
                        onChange="
                        if(this.checked) {
                    ...
                    <td class='tabla_fila'>
                        <input type='text' id='fap_ges_folio' name='fap_ges_folio' <?php if($fap[0]['fap_ges']!='t') echo 'DISABLED'; ?> value='<?php echo $fap[0]['fap_ges_folio']; ?>' size=10 />
                    </td>
                </tr>
                <tr>
            ...
            <table style='width:100%;font-size:11px;'>
                <tr>
                    <td class='sub-content' style='text-align:center;' colspan=2><b>Horario Flujo de Paciente</b></td>
                </tr>
                <tr>
                    <td class='tabla_fila2' style='text-align:right;'>Ingreso Pabell&oacute;n:</td>
                    <td class='tabla_fila'>
            ...
            <table style='width:100%;font-size:11px;'>
                <tr>
                    <td class='sub-content' style='text-align:center;' colspan=2>
                        <b>Equipo(s) Quir&uacute;rgico(s)</b>
        ...
        <table style='width:100%;'>
            <tr>
                <td class='tabla_fila2'>Observaciones</td>
            </tr>
            <tr>
                <td class='tabla_fila'>
        ...
        <td valign='top' style='width:50%;'>
            ...
            <div class='sub-content2' id='lista_presta' style='height:150px;overflow:auto;'>
            </div>
                ...
                <table style='width:100%;' cellpadding=0 cellspacing=0>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' id='cod_presta' name='cod_presta' size=10 onFocus='$("listado_fap").scrollTop=0;' />
                        </td>
            ...
            <table style='width:100%;'>
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input type='text' id='fap_suspension' name='fap_suspension' value='<?php echo $fap[0]['fap_suspension']; ?>' size=30 />
                    </td>
                </tr>
                <!--
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input type='checkbox' id='fap_sospecha_ges' name='fap_sospecha_ges' <?php if($fap[0]['fap_sospecha_ges']=='t') echo 'CHECKED'; ?> />
                    </td>
                </tr>
                -->
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input type='checkbox' id='fap_reoperado' name='fap_reoperado' <?php if($fap[0]['fap_reoperado']=='t') echo 'CHECKED'; ?> />
                    </td>
                </tr>
                <tr>
                    <td style='text-align:right;' class='tabla_fila2'>
                ...
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <input id='fap_hoja_cargo' name='fap_hoja_cargo' style='text-align:center;' value='<?php echo $fap[0]['fap_hoja_cargo']; ?>' />
                    </td>
                </tr>
            </table>
            <?php } ?>
            <br /><br />
            <center>
                <input type='button' onClick='boton_guardar();' style='width:80%;' id='btn_guardar' value='Guardar ...' /><br />
                <input type='button' onClick='ver_siguiente();' style='width:80%;' id='siguiente' value='Siguente Registro ...' /><br />
                <input type='button' onClick='ver_anterior();' style='width:80%;' id='anterior' value='Anterior Registro ...' /><br />
                <!-- <input type='button' onClick='eliminar_fap();' style='width:80%;' id='eliminar' value='Eliminar FAP ...' /><br /> -->
                <input type='button' onClick='listar_fap();' style='width:80%;' id='volver' value='Volver Atr&aacute;s ...' /><br />
            </center>
        </td>
    </tr>
</table>
