<?php 
    ...
    $esp=desplegar_opciones_sql("SELECT DISTINCT esp_id, esp_desc FROM nomina JOIN especialidades ON nom_esp_id=esp_id ORDER BY esp_desc");
?>
<script>
	...
	var myAjax=new Ajax.Updater('listado','prestaciones/consultar_nominas/listar_nominas.php',
        {
            method:'post',
...
<center>
    <div class='sub-content' style='width:950px;'>
        ...
        <div class='sub-content'>
            <form id='consulta' name='consulta' method='post' action='prestaciones/consultar_nominas/listar_nominas.php' onSubmit='return false;' />
                ...
                <table style='width:100%'>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' id='nombre_medico' ondblclick='$("doc_id").value="-1";$("rut_medico").value="";$("nombre_medico").value="";' value='' name='nombre_medico' size=35>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan=2 style='text-align:center;'>
                            <center>
                                <input type='button' id='actualiza' name='actualiza' onClick='listar_nominas();' value='-- Actualizar Listado... --' />
                                <input type='button' id='descarga' name='descarga' onClick='descargar_nominas();' value='-- Descargar Informe en XLS... --' />
                            </center>
                        </td>
                    </tr>
                </table>
