...
<script>
    listado = function()
    {
        ...
        var myAjax=new Ajax.Updater('tab_listado_content','agenda_medica/lista_espera/lista.php',
        {
    ...
    {
        var myAjax=new Ajax.Request('prestaciones/ingreso_egreso_hospital/info_hospitalizacion.php',
        {
            method:'post',
...
<center>
    <div class='sub-content' style='width:750px;'>
        <div class='sub-content' style='background-color:#cccccc;font-weight:bold;'>
        ...
        <form id='hosp' name='hosp' onSubmit='return false;' style='display: none;'>
            ...
            <div class='sub-content'>
                ...
                <!---
                <tr>
                    <td style='text-align:right;'>Previsi&oacute;n de Salud:</td>
                    <td colspan=3>
                ...
                -->
                <tr>
                    <td style='text-align:right;'>Modalidad de Atenci&oacute;n:</td>
                    <td colspan=3>
                ...
                <tr>
                    <td style='text-align:right;'>GES:</td>
                    <td colspan=3>
                ...
                <tr id='prog_social' name='prog_social' style='display:none;'>
                    <td style='text-align:right;'>Ley/Programa Social:</td>
                    <td colspan=3>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type='text' id='especialidad'  name='especialidad' value='' onDblClick='$("esp_id").value=""; $("especialidad").value="";' size=35>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type='text' id='especialidad2'  name='especialidad2' value='' onDblClick='$("esp_id2").value=""; $("especialidad2").value="";' size=35>
                    </td>
                </tr>
                <tr id='rut_medico_tr'>
                ...
                <tr>
                    <td style='text-align:right;'>Procedencia del Paciente:</td>
                    <td colspan=3>
                        <select id='procedencia' name='procedencia' onChange='if(this.value==4){$("inst_sel").style.display="";}else{$("inst_sel").style.display="none";}'>
                            <!--
                            <option value='-1'>(Seleccionar...)</option>
                ...
                <!---
                <tr>
                    <td style='text-align:right;'>N&uacute;mero Cama:</td>
                    <td colspan=3>
                        <input type='hidden' id='disponible' name='disponible' value='0'>
                        <input type='text' style='text-align:center;font-weight:bold;' id='nro_cama' name='nro_cama' size=10 onKeyUp='cargar_cama();'>
                        <input type='button' onClick='ver_camas();' value='- Disponibilidad Camas -'>
                    </td>
                </tr>
                <tr>
                    <td style='text-align:right;'>Tipo Cama:</td>
                    <td id='desc_cama' style='height:30px;' colspan=3>
                        <i>(Debe seleccionar cama...)</i>
                    </td>
                </tr>
                --->
                <tr>
                    <td style='text-align:right;'>Fecha Ingreso:</td>
                    <td colspan=3>
                        <select id='fecha0' name='fecha0'>
                            <option value='<?php echo date('d/m/Y');?>'><?php echo date('d/m/Y');?></option>
                            <option value='<?php echo date('d/m/Y',mktime(0, 0, 0, date("m")  , date("d")-1, date("Y")));?>'><?php echo date('d/m/Y',mktime(0, 0, 0, date("m")  , date("d")-1, date("Y")));?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td style='text-align:right;width:30%;'>Hora Ingreso:</td>
                    <td>
        ...
        <center>
            <br />
            <br />
            <input type='button' id='ingresar' style='display: none' value='- Guardar datos de Hospitalizaci&oacute;n -' onClick='guardar_hosp();'>
            <br />
            <br />
        </center>
    </div>
