...
function pac_fonasa($rutdv,$tipo) {
	...
	if($tipo_w==3){
		$rut1=cargar_registro("SELECT * FROM pacientes where pac_ficha='$rutdv'");
		$rutdv=$rut1['pac_rut'];
	}
...
User-Agent: Apache-HttpClient/4.1.1 (java 1.5)");
        ...
        switch ($tramo[1]) {
				...
				//print("INSERT INTO pacientes_fonasa VALUES (DEFAULT, CURRENT_TIMESTAMP, '$rutdv', '$data', '$cert_folio', $prevision, '$desc', '$prais');");

                pg_query("UPDATE pacientes SET prev_id=$prevision, pac_tramo='$tramo_fonasa', pac_estado=0 WHERE pac_rut='$rutdv'");
	...
	exit(pac_fonasa($_POST['rut'],$_POST['tipo_rut']));
