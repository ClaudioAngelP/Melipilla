			...
			<input type='hidden' id='xls' name='xls' value='0' />
				...
				<table style='width:100%;'>
					...
					<tr>
						...
						<td>
							<select id='tipo_informe' name='tipo_informe' onchange="actualizar_campos();">
                                ...
                                <option value='18' >Listado de Recetas Emitidas</option>
					...
					<tr>
						<td colspan=2>
							<center>
								<input id="btn_listar" type='button' onClick='listar_hosp();' 
								  value='-- Actualizar Listado... --'>
						
								<input id="btn_excel" type='button'  onClick='descargar_xls();' 
								value='-- Obtener Archivo XLS... --'>
                                                                <input id="btn_printrecetas" type='button' onClick='print_recetas();' 
                                                                       value='-- Imprimir recetas Emitidas... --' style="display: none;">
