    ...
    listar_fichas = function(index_busqueda)
    {
        ...
        */
        ...
        $j.ajax(
        {
            ...
            dataType: 'json',
            async:false,
            data: {especialidad:especialidad,tipo_busqueda:index_busqueda,doc_id:-1,fecha1:$j('#fecha1').val()},
...
//----------------------------------------------------------------------------
    pistolear_ficha = function ()
    {
        ...
        else
        {
            ...
            if(encontrado==true)
            {
                ...
                {
                    method:'post',
                    parameters:$('form_mov_fichas').serialize()+'&tipo_mov=1'+'&encontrado_rut='+encontrado_rut+'&encontrado_ficha='+encontrado_ficha+'&ubicacion='+$j('#select_origen').val(),
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    pistolear_ficha_unidad=function()
    {
        var datos_fichas="";
        ...
        else
        {
            ...
            if(encontrado==true)
            {
                ...
                'prestaciones/archivo_fichas/buzon_fichas/buscar_fichas.php',
		{
                    method:'post',
                                                            ...
                                                            <td>
                                                                <table id="table_codbarras" style="display: none">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" onblur="this.style.border=&quot;&quot;;this.style.background=&quot;&quot;;" onfocus="this.style.border=&quot;3px dashed red&quot;;this.select();" onkeyup="if(event.which==13) pistolear_ficha();" style="font-size: 15px; text-align: center;" size="25" name="barras" id="barras_recepcion" />
                                                                            <!--<input type="text" value="&lt;&lt; Seleccione Fichas con Código de Barras" style="font-size:18px;text-align:left;border:none;" disabled="" readonly="" size="60" name="texto_barras" id="texto_barras" />-->
                                                                        </td>
                                                                    </tr>
                                                                </table>
