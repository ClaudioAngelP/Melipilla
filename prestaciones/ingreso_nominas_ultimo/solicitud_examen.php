...
<script>
    ...
    agregar_prestacion_examen = function(index,llamada)
    {
        ...
        if(llamada==2)
        {
            ...
            var codigo=$('cod_presta_examen').value;
            var desc_presta=$('desc_presta_examen').value;
    ...
    listar_prestaciones_examen=function()
    {
        ...
        var html='<table style="width:100%;font-size:11px;"><tr class="tabla_header"><td>C&oacute;digo</td><td>Cant.</td><td>Descripci&oacute;n</td><td>Tipo Ex&aacute;men</td><td>Eliminar</td></tr>';    
                            ...
                            <div class='sub-content' style="display: none">
                                <table style='width:100%;' cellpadding=0 cellspacing=0>
                                    <tr>
                                        ...
                                        <td>
                                            <input type='text' id='cantidad_examen' name='cantidad_examen_examen' onKeyUp='if(event.which==13) agregar_prestacion_examen(0,2);' size=3 />
                                        </td>
                                    </tr>
                                </table>
                            </div>
