<?php
    ...
    if(!$informe_examen)
    {
        $inf=cargar_registro("SELECT * FROM nomina_detalle_informe JOIN doctores ON nomdi_doc_id=doc_id WHERE nomd_id=$nomd_id", true);
    }
    else
    {
        ...
        <table style='width:100%;'>
            ...
            ?>
                <tr>
                    ...
                    <td class='tabla_fila'>
                        <b><?php echo strtoupper($inf['sol_tipo_examen'])." -- ".strtoupper($inf['pc_codigo'])." -> ".strtoupper($inf['pc_desc'])." (".strtoupper($inf['pc_grupo']).")";?> </b>
                    </td>
                </tr>
            <?php
            }
