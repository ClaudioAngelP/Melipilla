<?php
    ...
    (CASE WHEN trim(both from pac_ficha)='' THEN '0' ELSE pac_ficha END)::bigint";
...
<html>
	...
	function mensaje_falso()
        ...
        function guardar_prestacion()
        {
            ...
            params+='&estado_ficha='+$('estado_ficha').value;
            <?php
        ...
        informe_examen=function(sol_examd_id)
        {
            ...
            new_win = window.open('form_informe.php?sol_examd_id='+sol_examd_id+'&nomd_id='+<?php echo $nomd_id;?>,
                            ...
                            <table style='width:100%;'>
                                ...
                                <tr>
                                    ...
                                    <td class='tabla_fila' colspan=3>
                                        ...
                                        <select name="estado_ficha" id="estado_ficha" style="width:100px;">
                                            <option value="OK">ATENDIDO</option>
                                ...
                                <tr>
                                    ...
                                    <td class='tabla_fila' colspan=3>
                                        ...
                                        <input type='text' id='nomd_diagnostico' value='<?php echo $ndet['nomd_diag']; ?>' name='nomd_diagnostico' size=35 onDblClick='$("nomd_diag_cod").value=""; $("nomd_diagnostico").value="";' />
                                        &nbsp;&nbsp;Paciente GES:&nbsp;&nbsp;
                                        <select id='ges'>
