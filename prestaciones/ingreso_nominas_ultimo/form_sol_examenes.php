...
<script>
    ...
    //--------------------------------------------------------------------------
    buscar_citacion=function(nomd_id,esp_id,sol_id)
    {
    ...
    listar_solicitudes=function()
    {
        ...
        $j.ajax(
        {
            ...
            dataType: 'json',
            async:false,
            data: {pac_id:$('pac_id').value,esp_id:$('esp_id').value,list:list,estado_solicitudes:$('estado_solicitudes').value},
            ...
            for(var i=0;i<registros_examenes[0].length;i++)
            {
                if(i==0)
                {
                    ...
                    html+='<tr class="tabla_header">';
                        ...
                        html+='<td colspan=3 style="font-weight:bold;text-align:right;">';
                            html+="<img src='iconos/date_magnify.png'  style='cursor:pointer;' width='22px;' height='22px;' alt='Citaciones Similares' title='Citaciones Similares' onClick='buscar_citacion("+registros_examenes[0][i]['sol_nomd_id_original']+","+registros_examenes[0][i]['sol_esp_id']+","+registros_examenes[0][i]['sol_exam_id']+");' />";
                    ...
                    html+='</tr>';
                    html+='<tr class="tabla_header">';
                    html+='<td style="text-align:left;font-size:11px;">Fecha Solicitud:</td>';
                    html+='<td style="font-weight:bold;text-align:left;width:380px;">&nbsp;'+registros_examenes[0][i]['fecha_solicitud']+'</td>';
                    html+='<td style="text-align:right;font-size:11px;">Solicitado por:</td>';
                    html+='<td style="font-weight:bold;text-align:left;">&nbsp;'+registros_examenes[0][i]['func_nombre']+'</td>';
                    html+='</tr>';
                    html+='<tr class="tabla_header">';
                        html+='<td style="text-align:left;font-size:11px;">Rut Paciente:</td>';
                        html+='<td colspan=3 style="font-weight:bold;text-align:left;width:600px;"">&nbsp;'+registros_examenes[0][i]['pac_rut']+'</td>';
                    html+='</tr>';
                    html+='<tr class="tabla_header">';
                        html+='<td style="text-align:left;font-size:11px;">Paciente:</td>';
                        html+='<td colspan=3 style="font-weight:bold;text-align:left;width:600px;"">&nbsp;'+registros_examenes[0][i]['nombre_paciente']+'</td>';
                    html+='</tr>';
                    html+='<tr>';
                        html+='<td colspan=4 class="tabla_header" style="text-align:center;border-color: #000000;border-left: 2px solid #000000;border-style: solid;border-width: 1px 1px 2px 2px;margin: 1px;padding: 0;">';
                            html+='<table style="width:100%" border="0">';
                                html+='<tr class="tabla_header">';
                                ...
                                html+='<tr class="tabla_fila" style="background-color:'+color+'" onMouseOver="this.style.background=\'#9999FF\';" onMouseOut="this.style.background=\''+color+'\';">';
                                    ...
                                    {
                                        html+='<td style="text-align:center;">';
                                        html+='<img src="iconos/tick.png" title="Ex&aacute;men Realizado" style="cursor:pointer;" onClick="ver_informe();">';
                                        html+='</td>';
                                    }
                                    else
                                    {
                ...
                {
                    if(nomd_id==registros_examenes[0][i]['sol_nomd_id_original'])
                    {
                        color='';
                        if(registros_examenes[0][i]['sol_examd_nomd_id']!='0')
                        {
                    ...
                    else
                    {
                        ...
                        html+='<br>';
                        html+='<hr align="center" size="4" width="100%" color="maroon" />';
                        html+='<br>';
                        cont=0;
                        html+='<table style="width:100%" border="0">';
                        html+='<tr class="tabla_header">';
