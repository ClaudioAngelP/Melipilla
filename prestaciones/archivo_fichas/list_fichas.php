...
<script type="text/javascript" >
    ...
    pistolear_ficha_list=function()
    {
        ...
        {
            method:'post',
            parameters:'barras='+$('barras_list').value+'&list_ficha=1',
            onComplete:function(r)
            {
                try
                {
                    ...
                    if(!datos)
                    {
                        alert('Error Ficha no encontrada');
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if(encontrado==false)
                            {
                                ...
                                lista_envio[num].ubicacion_actual=datos[0]['ubic_actual'];
                                dibujar_lista();
            ...
            html+='<table style="width:100%" border="0">';
                ...
                for(var i=(lista_envio.length-1);i>=0;i--)
                {
                    ...
                    html+='<tr class="'+clase+'" style="color:'+opts_color[(lista_envio[i].am_estado*1)]+'">';
                        ...
                        html+='<td style="text-align:left;">'+lista_envio[i].ubicacion_actual+'</td>';
    ...
    enviar_masivo=function()
    {
        ...
        {
            method:'post',
            parameters:'&llamada=1&fichas='+encodeURIComponent(lista_envio.toJSON())+'&destino_esp='+$('destino_masivo_esp').value+'&destino_serv='+$('destino_masivo_serv').value+'&motivo_envio='+$('amp_id').value+'&tipo_destino='+$('select_tipo_destino').value+'&doc_id='+$('doc_id').value,
            onComplete:function(r)
            {
                try
                {
                    ...
                    $('chk_list_envio').checked = false;
                    $("form_listfichas").win_obj.close();
