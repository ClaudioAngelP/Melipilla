...
<script>
	...
	else
	{
        ...
        left=Math.round(screen.width/2)-340;
        new_win = 
        window.open('prestaciones/archivo_fichas/imprimir_fichas.php?esp_id='+esp_id+'&fecha='+fecha+'&agrupar='+agrupar+'&doc_id='+doc_id+'&tipo_inf='+$('tipo_inf').value+'&proceso='+proceso,
        'win_nomina', 'toolbar=no, location=no, directories=no, status=no, '+
        'menubar=no, scrollbars=yes, resizable=no, width=680, height=500, '+
        'top='+top+', left='+left);
        new_win.focus();
