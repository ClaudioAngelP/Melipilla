...
//----------------------------------------------------------------------------
    ...
    pistolear_ficha_unidad=function(nomd_id)
    {
		...
		{
                    method:'post',
                    parameters:'ubicacion='+ubicacion+'&tipo_busqueda=4&option=2&doc_id='+$j('#doc_id').val()+'&fecha2='+fecha_ficha+'&ficha='+$j('#barras_unidad').val(),
                    onComplete:function(r)
                    {
                        try
                        {
                            ...
                            <tr>
                                <td valign='top' >
                                    <div class='sub-content'>
                                        ...
                                        <!--
                                        <select name='select_opcion' id='select_opcion' TABINDEX="1" onchange="cambiar_opcion();">
                                            <option value="1" selected>Movimientos de Fichas</option>
                                            <option value="2" >Buscar Ficha</option>
                                        </select>
                                        -->
                                    </div>
