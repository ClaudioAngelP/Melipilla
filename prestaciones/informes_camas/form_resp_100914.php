...
descargar_xls=function() {
	...
	completa_info=function(hosp_id) {
	 ...
	 imprimir_urgencia_pdf1 = function(){
		...
		window.open('prestaciones/informes_camas/imprimir_urgencia_pdf.php?doc_id='+$('doc_id').value*1+'&nombre_medico='+$('nombre_medico').value, '_blank');
	}	
			...
			<input type='hidden' id='xls' name='xls' value='0' />
				...
				<option value='24'>Informe Hospitalizados Neonatolog&iacute;a</option>
					...
					<!--AUTOCOMPLETAR MEDICO-->
						...
						style='text-align: center;' value='<?php echo $r[0]['doc_rut']; ?>' readOnly></td></tr>

						<tr id='nombre_medico_tr'>
							<td style='text-align:right;'>M&eacute;dico Jefe:</td>
						<td>
						...
						<input type='text' id='nombre_medico' name='nombre_medico' size=35
						 onDblClick='$("rut_medico").value="";$("doc_id").value="";$("nombre_medico").value="";'
				   ...
				   <tr id='tr_estado_cama'>
					<td style='text-align:right;white-space:no-wrap;'>Estado Cama:</td><td><span id='estado_cama'></span></td>
				   </tr>
