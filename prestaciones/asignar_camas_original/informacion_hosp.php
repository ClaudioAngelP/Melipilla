...
<html>
    ...
    <body class='fuente_por_defecto popup_background'>
                ...
                <table style='width:100%;'>
                    ...
                    <tr>
                        ...
                        <td colspan=3>
                            ...
                            <input type='text' id='diagnostico' name='diagnostico' value='<?php echo $r[0]['hosp_diagnostico']; ?>' size=65 onDblClick='$("diag_cod").value=""; $("diagnostico").value="";' />
                        </td>
                        <tr>
                            ...
                            <td colspan=3>
                                ...
                                <input type='text' id='diagnostico2' value='<?php echo $r[0]['hosp_diagnostico2']; ?>' name='diagnostico2' size=65 onDblClick='$("diag_cod2").value=""; $("diagnostico2").value="";' />
                            </td>
                        </tr>
                        <tr>
        ...
        <div class='sub-content' id='registro_hoja_cargo' style='display:none;'>
            ...
            <div class='sub-content2' id='listado_hoja_cargo' style='height:300px;overflow:auto;'></div>
        </div>
