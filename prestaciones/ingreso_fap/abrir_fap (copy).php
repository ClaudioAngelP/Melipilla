...
<input type='button' onClick='protocolo_fap(<?php echo $fap_id.','.$ub; ?>);' 
style='width:80%; font-size:18px;font-weight:bold;' id='btn_guardar' value='Protocolo Quir&uacute;rgico ...' /><br />

<input type='button' onClick='checklist_fap(<?php echo $fap_id.','.$ub; ?>);' 
style='width:80%;font-size:18px;font-weight:bold;' id='btn_guardar' value='Pausa de Seguridad ...' /><br />

<input type='button' onClick='comprueba_pausa(<?php echo $fap_id; ?>,0,0,<?php echo $ub; ?>);'
style='width:80%;font-size:18px;font-weight:bold;' id='btn_guardar' value='Imprimir Pausa de Seguridad ...' /><br />
<br /><br />


<input type='button' onClick='boton_guardar();' 
style='width:80%;font-size:18px;font-weight:bold;' id='btn_guardar' value='Guardar ...' /><br /><br />
