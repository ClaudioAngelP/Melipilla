<?php
	...
	$pdf->Cell(190,4,utf8_decode('Servicio de Salud de Reloncaví'),0,1,'L');
	...
	$pdf->Cell(190,5,utf8_decode('Nro. Folio: '.$fap['fap_fnumero'].' | Fecha Intervención: '.substr($fap['fap_fecha'],0,10)),0,1,'C');
