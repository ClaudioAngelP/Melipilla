...
//print($_POST['presta']);
	...
	if($fap_tipo==5) {   
   	...
   	for($i=0;$i<$nume;$i++) {
   		...
   		$cir4_t=$equipo[$j]['11']['turno']*1;   		$ane1_t=$equipo[$j]['3']['turno']*1;
   		$ane2_t=$equipo[$j]['4']['turno']*1;

   		$enf=$equipo[$j]['15']['id']*1;   		$inst=$equipo[$j]['5']['id']*1;
   		$inst2=$equipo[$j]['12']['id']*1;
   		$pab=$equipo[$j]['6']['id']*1;
   		$pab2=$equipo[$j]['13']['id']*1;
   		$tecanes=$equipo[$j]['7']['id']*1;
   		$tecanes2=$equipo[$j]['14']['id']*1;
   		...
   		pg_query("INSERT INTO fap_equipo_quirurgico VALUES (
				...
				$cir1_t,$cir2_t,$cir3_t,$ane1_t,$ane2_t,$cir4,$inst2,$pab2,$tecanes2,$enf,$cir4_t
   		);");
