<?php 
	...
	$suspension=pg_escape_string(trim(utf8_decode($_POST['fap_suspension'])));
...
*/	
	...
	print("INSERT INTO fap_pabellon VALUES (
		$fid,
	...
	// GUARDAR PAUSA DE SEGURIDAD (RECEPCION) CHECKLIST ID: 9
		$_POST['fap_id']=$fap_id;
		$_POST['selector']=9; // ID CHECKLIST...
		require_once('sql_checklist.php');
	// FIN GUARDAR CHECKLIST...
