...
<script>
	listado=function() {
		...
		var myAjax=new Ajax.Updater(
			'lista_pacientes',
			'prestaciones/busqueda_rapida/lista_desplegable.php',
   ...
   visualizar_camas = function(id) {
	...
	imprimir_listado=function() {
		...
		var html="<h2>Informe Datos Paciente - Evolucion</h2><br />";
...
<b>Gesti&oacute;n Centralizada de Camas - Busqueda Rapida</b>
</div>
...
<input type='text' id='busqueda' name='busqueda' size=45 onKeyUp='
   if(event.which==13)listado();'/>
</td></tr>
