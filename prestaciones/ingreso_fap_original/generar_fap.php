<?php
	...
	"fapp_id, fapp_desc",($fap?$fap['fap_numpabellon']:-1),'true','ORDER BY fapp_id'); 
...
<tr><td class='tabla_fila2' style='text-align:right;width:100px;'>Paciente:</td>
...
<tr><td class='tabla_fila2' style='text-align:right;width:100px;'>Buscar:</td>
<td class='tabla_fila' style='width:25%;' colspan=3>
...
<table style='display:none;' id='ingreso_pac' 
...
<td class='tabla_fila' colspan=3>
<input type='text' id='fap_suspension' name='fap_suspension' size=60 value='<?php if($fap) echo htmlentities($fap['fap_suspension']); ?>' /></td>
</tr>
