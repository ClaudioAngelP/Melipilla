                            ...
                            <td valign='top'>
                                <table style='width:100%;font-size:12px;'>
                                    <tr>
                                        ...
                                        <td class='tabla_fila' style='width:30%;'>
                                        ...
                                        <td class='tabla_fila'>
                                            <input type='text' id='profesional' name='profesional'  onDblClick='limpiar_profesional();' style='text-align:left;font-size:10px;' DISABLED size=35 />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='tabla_fila2' style='text-align:right;'>Especialidad</td>
                                        <td class='tabla_fila' id='select_especialidades' style='width:30%;'>
