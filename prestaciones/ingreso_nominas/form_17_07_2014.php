...
<script>
    ...
    calcular_totales=function(index)
    {
        ...
        //{
            ...
            var myAjax=new Ajax.Request('prestaciones/ingreso_nominas/sql_ligero.php', {method:'post',asynchronous:false,parameters:$('info_nominas').serialize()+'&nomd_id='+nomd_id});
            //console.log('ok!');
        //}
