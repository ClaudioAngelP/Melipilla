<?php
    ...
    */
    ...
    if($pac_id!="0" && $pac_id!="")
    {
        ...
        ORDER BY nom_fecha desc, nomd_hora;
        ";
...
<html>
    ...
    <body class='fuente_por_defecto popup_background' onLoad='init();'>
        ...
        <form id='datos_pac' name='datos_pac' onSubmit='return false;'>
            ...
            <?php if($nd) { ?>
            <div class='sub-content2' style='height:250px;overflow:auto;' id='nominas_paciente'>
                            ...
                            if($p)
                            {
                                for($i=0;$i<sizeof($p);$i++)
                                {
                                    ...
                                    <tr class='$clase'>
                                        <td>
                                            <center>
                                                <input type='checkbox' id='presta_".$i."_".$p[$i]['presta_codigo']."' name='presta_".$i."_".$p[$i]['presta_codigo']."' value='1' CHECKED />
                                            </center>
                                        </td>
