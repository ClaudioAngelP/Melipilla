    ...
    if($lista){
	    ...
	    <option value='R' ".($lista[$i]['nomd_tipo']=='R'?'SELECTED':'').">R</option>
            ...
            */
            ...
            <td>
                <center>
                    <select onChange='calcular_totales();' id='nomd_sficha_".$lista[$i]['nomd_id']."' name='nomd_sficha_".$lista[$i]['nomd_id']."' $disabled_input>
            ...
            <td style='white-space:nowrap;'>
                <center>");
                    ...
                    print("
                    <select onChange='calcular_totales();' style='width:100px;' id='nomd_diag_cod_".$lista[$i]['nomd_id']."' name='nomd_diag_cod_".$lista[$i]['nomd_id']."' $disabled_input>
                    ");
                    if($estado_cupo)
                    {
                        print("
            ...
            <td style='white-space:nowrap'>
                <center>");
                    ...
                    {
                        print("
                        <select onChange='calcular_totales();' id='nomd_motivo_".$lista[$i]['nomd_id']."' name='nomd_motivo_".$lista[$i]['nomd_id']."' $disabled_input>
                            <option value='S'>S</option>
                            <option value='N' SELECTED>N</option>
                        </select>");
                        
                        print("<select onChange='calcular_totales();' id='nomd_motivo2_".$lista[$i]['nomd_id']."' name='nomd_motivo2_".$lista[$i]['nomd_id']."' $disabled_input>
                            <option value='S'>S</option>
                            <option value='N' SELECTED>N</option>
                        </select>");
            ...
            <td style='white-space:nowrap;'>
                <center>
                    <select style='width:100px;' onChange='calcular_totales();' id='nomd_origen_".$lista[$i]['nomd_id']."' name='nomd_origen_".$lista[$i]['nomd_id']."' $disabled_input>
            ...
            <td>
                <center>
                    <select onChange='calcular_totales();' id='nomd_auge_".$lista[$i]['nomd_id']."' name='nomd_auge_".$lista[$i]['nomd_id']."' $disabled_input>
