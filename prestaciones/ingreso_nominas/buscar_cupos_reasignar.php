...
<?php
    ...
    if($tipo_cupos==1)
    {
        ...
        select nomina.nom_id,COALESCE(nomina.nom_estado,0)as nom_estado,nom_esp_id,nom_doc_id,nom_fecha::date,nom_motivo,doc_rut,doc_paterno,doc_materno,doc_nombres,nom_folio,cupos_cantidad_c,
        (
...
<?php
            for($i=0;$i<sizeof($c);$i++)
            {
                ...
                $consulta="SELECT DISTINCT nomd_hora FROM nomina_detalle WHERE nom_id=$nom_id AND nomd_hora IS NOT NULL AND NOT nomd_hora='00:00:00' AND (nomd_diag_cod NOT IN ('T','X')) ORDER BY nomd_hora";
                ...
                print("<tr class='$clase' onMouseOver='this.className=\"mouse_over\";' onMouseOut='this.className=\"$clase\";'>
                    ...
                    if($reg_horas){
                        ...
                        print("<td style='text-align:center;font-size:20px;'>0</td>");
                    }
