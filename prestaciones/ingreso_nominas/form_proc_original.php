        ...
        certificar_receta = function()
        {
            ...
            */
            ...
            ?>
                ...
                //var cant_chk=0;
                for(var x=0;x<examenes.length.length;x++)
                {
            ...
            <table style='width:100%;height:500px;'>
                <tr>
                    <td valign='top'> 
                        ...
                        if($reg_inter)
                        {
                            $consulta="SELECT e1.esp_desc, inter_fundamentos, inter_examenes,inter_comentarios, inter_estado, inter_rev_med,inter_prioridad,i1.inst_nombre,
                            inter_inst_id1,inter_motivo,inter_diag_cod,inter_diagnostico,COALESCE(garantia_nombre, ''),COALESCE(garantia_id, 0),i2.inst_nombre AS inst_nombre2,
                            inter_inst_id2,inter_ingreso, ice_icono, ice_desc,unidad.esp_desc AS unidad_desc, inter_unidad,inter_motivo_salida,icc_desc,
                            inter_fecha_salida FROM interconsulta LEFT JOIN especialidades AS e1 ON inter_especialidad=e1.esp_id LEFT JOIN instituciones AS i1 ON inter_inst_id1=inst_id
                            LEFT JOIN instituciones AS i2 ON inter_inst_id2=i2.inst_id LEFT JOIN garantias_atencion ON inter_garantia_id=garantia_id
                            LEFT JOIN interconsulta_estado ON inter_estado=ice_id LEFT JOIN especialidades AS unidad ON inter_unidad=unidad.esp_id		
                            LEFT JOIN interconsulta_cierre ON inter_motivo_salida=icc_id WHERE inter_id=".$reg_inter['inter_id']."";
                            ...
                            <table style='width:100%;'>
                                ...
                                <tr id='serv_tr'>
                                    ...
                                    <td class='tabla_fila'>
                                        ...
                                        <input type='text' id='centro_nombre_oa' name='centro_nombre_oa' value='' size=35 onDblClick='$("centro_ruta_oa").value=""; $("centro_nombre_oa").value="";' />
                                    </td>
                                </tr>
                                <tr id='unid_tr'>
                                    <td style='text-align:right;' class='tabla_fila2'>
                                    ...
                                    <td class='tabla_fila'>
                                        ...
                                        <input type='text' id='esp_desc_oa' name='esp_desc_oa' value='' size=35 onDblClick='$("esp_id_oa").value=""; $("esp_desc_oa").value="";' />
                                    </td>
                                </tr>
                                <tr id='medi_tr'>
                                    <td style='text-align:right;' class='tabla_fila2'>
                                    ...
                                    <td class='tabla_fila'>
                                        ...
                                        <input type='text' id='doc_nombre_oa' name='doc_nombre_oa' value='' size=35 onDblClick='$("doc_id_oa").value=""; $("doc_rut_oa").value=""; $("doc_nombre_oa").value="";' />
                                    </td>
                                </tr>
                        ...
                        ?>
                            ...
                            <div class='sub-content2' id='lista_exam' style='height:120px;overflow:auto;'>
                                    ...
                                    for($i=0;$i<count($reg_examenes);$i++)
                                    {
                                        ...
                                        print('<tr class="'.$clase.'" onMouseOver="this.className=\'mouse_over\';" onMouseOut="this.className=\''.$clase.'\';">');
                                            ...
                                            print('<td style="text-align:center;font-size:10px;">');
                                                ...
                                                {
                                                    print('<input type="checkbox" id="chk_realizado_'.$i.'" name="chk_realizado_'.$i.'" onChange="">');
                                                }
                                                else
                                                {
                                            ...
                                            <td>
                                                <center>
                                                    <img src='../../iconos/script_edit.png'  style='cursor:pointer;' onClick='informe_examen(".($reg_examenes[$i]['sol_examd_id']).");' />
                                                </center>
                                            </td>
                                            ");
                                        print('</tr>');
