<?php 
	...
	$r=cargar_registros_obj("SELECT *,f1.func_nombre AS func_ingreso,f2.func_nombre AS func_egreso FROM hospitalizacion 
...
<?php 
	...
	for($i=0;$i<sizeof($censo);$i++) {
		...
		print("<tr class='$clase'>
			...
			onClick='categorizar_paciente(1,".$censo[$i]['censo_id'].",".$censo[$i]['hosp_id'].");' /></center>			
			</td></center>
		</tr>");
	}
