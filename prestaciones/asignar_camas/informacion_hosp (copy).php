...
<script>
	...
	function guardar_info() {
		...
		if($('tcama_id').value!='-1' && $('tcama_id').value!='-2' && 
			($('cama_id')==null || $('cama_id').value=='-1')) {
...
Fecha de Ingreso:</td><td>
<input type='text' name='hosp_fecha_ing' id='hosp_fecha_ing' value="<?php echo $r[0]['hosp_fecha_ing']; ?>" size='10'>
<img src='../../iconos/date_magnify.png' name='fecha_boton' id='fecha_boton'>
<input type='text' id='hosp_hora_ing'  name='hosp_hora_ing' style='text-align:center;'
onBlur='validacion_hora(this);' value='<?php echo substr($r[0]['hosp_hora_ing'],0,5); ?>' onDblClick='' size='5'>
</td>
</tr>
...
<input type='text' id='especialidad2'  name='especialidad2' value='<?php echo $r[0]['esp_desc2']; ?>' 
...
<input type='text' id='nombre_medico' name='nombre_medico' size=35
   ...
   <td style='text-align:right;'>Estado:</td>
	<td><select id='hest_id' name='hest_id' onchange='select_estado();'>
	...
	<tr id="tr_fecha_egreso" style="display:none;">
		...
		<td><input style="text-align:center;" size=6 type="text" id="hosp_fecha_egr" name="hosp_fecha_egr" value="<?php if($r[0]['hosp_fecha_egr']=="") { echo $hoy; } else { echo $r[0]['hosp_fecha_egr']; } ?>"><img src='../../iconos/date_magnify.png' name='fecha_boton2' id='fecha_boton2'> <input style="text-align:center" size=6 type="text" id="hosp_hora_egr" name="hosp_hora_egr" value="<?php if($r[0]['hosp_hora_egr']=="") { echo $hora; } else { echo substr($r[0]['hosp_hora_egr'],0,5); } ?>"></td>
	</tr>
   ...
   <td style='text-align:right;'>Condici&oacute;n:</td>
	<td><select id='hcon_id' name='hcon_id' >
	<?php
...
value='<?php echo $r[0]['hosp_diag_cod']; ?>' DISABLED size=5 style='font-weight:bold;text-align:center;' />
<input type='text' id='diagnostico' name='diagnostico'
value='<?php echo $r[0]['hosp_diagnostico']; ?>' size=35
onDblClick='$("diag_cod").value=""; $("diagnostico").value="";' /></td>
<tr id='tr_diag_egr'>
...
<input type='button' id='anular' name='anular'
 onClick='anular_hosp();'value='-- Anular Hospitalizaci&oacute;n... ---'>             
<br /><br />
</center>
