<?php 
    ...
    $tipo=$_POST['select_tipo']*1;
    $w_tipo="true";
    if($tipo==1){
        $w_tipo=" hospa_prioridad=0 ";
...
<input type="" id="cant_registros" name="cant_registros" value="<?php if($l){echo sizeof($l);}else{ echo "0";};?>">
