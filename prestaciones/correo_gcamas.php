<?php
	...
	$q=cargar_registros_obj("
		...
		$objPHPExcel->getProperties()->setCreator("Sistema GIS Hospital Gustavo Fricke")
							 ...
							 ->setTitle("Pacientes Hospitalizados durante mas de 5 días.")
							 ->setSubject("Pacientes Hospitalizados durante mas de 5 días.")
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C2', 'Pacientes hospitalizados por mas de 5 días.');
...
<i>Adjuntamos a ustedes, tabla adjunta con detalle de pacientes <b>hospitalizados por m&aacute;s de 5 d&iacute;as</b> seg&uacute;n registros del Sistema GIS.</i>
...
error_reporting(E_ALL);
 ...
 for($i=0;$i<sizeof($mail_array);$i++) {
    ...
    send_mail($email,'sistemagis.hgf@redsalud.gov.cl',utf8_decode('Resumen Pac. Excedidos - Sistema Gestión de Camas '.date('d/m/Y')),$html);
 }
