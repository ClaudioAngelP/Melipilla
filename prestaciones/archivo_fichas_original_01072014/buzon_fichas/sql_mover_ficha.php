<?php 
        ...
        */
        ...
        if(strstr($esp_id2,'.'))
        {
            if($esp_id=="" || $esp_id=="0" || $esp_id==0)
            {
                if($centro_ruta_origen!="")
                {
                    if($estado==3)
                    {
                        pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id, $doc_id, 0, $doc_id2, $estado, '', true,'$centro_ruta_origen','$centro_ruta_destino');");
                    }
                    else
                    {
                        pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id, $doc_id, 0, $doc_id2, $estado, '', true,'$centro_ruta_destino','$centro_ruta_origen');");
                ...
                else
                {
                    ...
                    {
                        pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, 0, $doc_id, 0, $doc_id2, $estado, '', true,'$centro_ruta_destino','$esp_id2');");
                    }
                    else
                    {
                        pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id_origen, $doc_id, 0, $doc_id2, $estado, '', true,null,'$esp_id2');");
                    }
                }
            }
            else
        ...
        else
        {
            if($esp_id=="" || $esp_id=="0" || $esp_id==0)
            {
                if($centro_ruta_destino!="")
                {
                    pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, 0, $doc_id, $esp_id2, $doc_id2, $estado, '', true,'$centro_ruta_destino',null);");    
                }
                else
                {
                    
                    pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id_origen, $doc_id, $esp_id2, $doc_id2, $estado, '', true,null,null);");    
                }
            }
            else
            {
                ...
                if($centro_ruta_origen!="")
                {
                    pg_query("INSERT INTO archivo_movimientos VALUES (DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id, $doc_id, $esp_id2, $doc_id2, $estado, '', true,'$centro_ruta_origen',null);");
                }
                else
                {
	...
	$doc_id=$chk['destino_doc_id']*1;
        ...
        {
            pg_query("INSERT INTO archivo_movimientos VALUES(DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, 0, $doc_id, $esp_id2, $doc_id2, $estado, '', true,'$am_centro_ruta_destino',null);");
        }
        else
        {
            pg_query("INSERT INTO archivo_movimientos VALUES(DEFAULT, CURRENT_TIMESTAMP, $func_id, $pac_id, '$pac_ficha', $nomd_id, $esp_id, $doc_id, $esp_id2, $doc_id2, $estado, '', true,null,null);");
