...
<script type="text/javascript" >
    ...
    $j(document).ready(function()
    {
        $j('#select_origen').change(function()
        {
            ...
            if(n!=-1)
            {
                //$('tr_profesional').style.display='none';
                //$('doc_rut').style.display='none';
                $j('#doc_rut').css("display","none");
                $j('#btn_solicitud_servicio').css("display","block");
                $j('#span_doc_nombre').html('');
                $j('#span_profesional').html('');
                
            }
            else
            {
                
                //$j('#doc_rut').css("display","block");
                $('doc_rut').style.display='';
                $('btn_solicitud_servicio').style.display='none';
                $j('#span_doc_nombre').html('(Todos los Profesionales...)');
                $j('#span_profesional').html('Profesional:');
            }
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan=3 valign="top">
                                                    ...
                                                    <input type='button' id='btn_solicitud_servicio' name='btn_solicitud_servicio' value='Solicitar Ficha' style="display:none" onclick="solicitar_ficha_servicio();"/>
                                                </td>
                                            </tr>
                                        </table>
