<?php 
	...
	if($tcama_id>0) {
		$t=cargar_registro("SELECT * FROM clasifica_camas WHERE tcama_id=$tcama_id");
		...
		$t=cargar_registro("SELECT MIN(tcama_num_ini) AS tcama_num_ini,	MAX(tcama_num_fin) AS tcama_num_fin FROM clasifica_camas where tcama_id>58");
		$ini=$t['tcama_num_ini']*1;
		$fin=$t['tcama_num_fin']*1;
