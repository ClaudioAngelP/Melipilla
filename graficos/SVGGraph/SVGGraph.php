...
abstract class Graph {
   ...
   */
    public function Element($name, $attribs = NULL, $styles = NULL, $content = NULL)
    {
        ...
        $require_units = array('stroke-width' => 1, 'stroke-dashoffset' => 1,'font-size' => 1, 'baseline-shift' => 1, 'kerning' => 1,'letter-spacing' =>1, 'word-spacing' => 1);
   ...
   */
    public function Render($header = TRUE, $content_type = TRUE, $defer_javascript = FALSE)
    {
