...
<html>
	<head>
        <title><?php echo htmlentities($sghnombre); ?></title>
    ...
    <div id="header">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                <strong><?php echo htmlentities($sghnombre); ?></strong><br>
                <span style="font-size: 24px;"><?php echo htmlentities($sghinstitucion);?></span>
            </td>
            <td style="width:300px;">
                ...
                <tr>
                    ...
                    <td><i><?php print (htmlentities($_SESSION['sgh_cargo'])); ?></i></td>
                </tr>
          ...
          <td style="width:90px;">
            <div style="text-align: center; font-size: 10px;">
            	<img src="iconos/comments.png" style="width:30px;height:30px;cursor:pointer;" onClick="chat();" /><br />
