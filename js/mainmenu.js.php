...
function createjsDOMenu() {
  ...
  with (menusesion) {
    ...
    addMenuItem(new menuItem("Cerrar Sesión...", "", "login.php"));
...
<?php 
  ...
  addMenuItem(new menuItem("Codificación Masiva O.C.", "", "javascript:cambiar_pagina(\'abastecimiento/codificacion_masiva/form.php\');"));
 ...
 ');
  ...
  addMenuItem(new menuItem("Recepción de Consumo Inmediato", "", "javascript:cambiar_pagina(\'abastecimiento/recepcion_gastos/form.php\');"));
  addMenuItem(new menuItem("Recepción de Facturas", "", "javascript:cambiar_pagina(\'abastecimiento/recepcion_facturas/form.php\');"));
  ...
  addMenuItem(new menuItem("Historial de Recepción", "", "javascript:cambiar_pagina(\'abastecimiento/historial_recepcion/form.php\');"));
...
if(_cax(41)) {
  ...
  addMenuItem(new menuItem("Recepción Recetas NPT", "", "javascript:cambiar_pagina(\'recetas/receta_npt/form_consultar.php\');"));
  ...
  addMenuItem(new menuItem("Indice de Rotación de Artículos", "", "javascript:cambiar_pagina(\'abastecimiento/informe_rotacion/form.php\');"));
  ...
  addMenuItem(new menuItem("Revisión Solicitudes de Compra", "", "javascript:cambiar_pagina(\'abastecimiento/revision_solicitudes/form.php\');"));
  ...
  addMenuItem(new menuItem("Listado de Reposición", "", "javascript:cambiar_pagina(\'abastecimiento/listado_reposicion/form.php\');"));');
  ...
  if(_cax(19)) {
   ...
   print('
    ...
    addMenuItem(new menuItem("Búsqueda de Recetas", "", "javascript:cambiar_pagina(\'recetas/ver_recetas/form.php\');"));
  ...
  print('
    ...
    addMenuItem(new menuItem("-"));
    addMenuItem(new menuItem("Reporte Fármacos Restringidos/GES/MAC", "", "javascript:cambiar_pagina(\'recetas/reporte_farmacos/form.php\');"));
  ...
  if(_cax(502) OR _cax(503)){
   ...
   print('
    addMenuItem(new menuItem("Autorización de Fármacos", "", "javascript:cambiar_pagina(\'ficha_clinica/autorizar_farmacos/form.php\');"));
  ...
  if(_cax(504)){
   ...
   print('
    addMenuItem(new menuItem("Autorización de Antimicrobianos", "", "javascript:cambiar_pagina(\'ficha_clinica/autorizar_antimicrobianos/form.php\');"));
  ...
  addMenuItem(new menuItem("Ingresar O.A. Hospitalización", "", "javascript:cambiar_pagina(\'prestaciones/orden_hospitalizacion/form.php?tipo=2\');"));
  ...
  addMenuItem(new menuItem("Revisión de Solicitudes", "", "javascript:cambiar_pagina(\'interconsultas/revision_inter/form.php\');"));
  ...
  $menu_principal.='addMenuBarItem(new menuBarItem("Gestión de Camas", menucamas));';
  ...
  print('
      addMenuItem(new menuItem("Asignación de Camas", "", "javascript:cambiar_pagina(\'prestaciones/asignar_camas/form.php\');"));
     ');

  if( _cax(253) AND !_cax(250) AND !_cax(251))
  print('
      addMenuItem(new menuItem("Visualizar Gestión Central de Camas", "", "javascript:cambiar_pagina(\'prestaciones/asignar_camas/form.php\');"));
     ');
  ...
  if( _cax(252) ){
	print('
     ...
     ');
   print('
      addMenuItem(new menuItem("Informes Gestión de Camas", "", "javascript:cambiar_pagina(\'prestaciones/informes_camas/form.php\');"));
     ');
   }
  ...
  // addMenuItem(new menuItem("Informe Estadístico de Nóminas", "", "javascript:cambiar_pagina(\'prestaciones/consultar_nominas/form.php\');"));
  ...
  if(_cax(202) OR _cax(300))
	print('
      addMenuItem(new menuItem("Nóminas de Atención", "", "javascript:cambiar_pagina(\'prestaciones/ingreso_nominas/form.php\');"));
	addMenuItem(new menuItem("Nóminas de Reagendamiento", "", "javascript:cambiar_pagina(\'prestaciones/ingreso_nominas/form_reagendar.php\');"));
      addMenuItem(new menuItem("Informe Estadístico de Nóminas", "", "javascript:cambiar_pagina(\'prestaciones/consultar_nominas/form.php\');"));
	');
  
  // addMenuItem(new menuItem("Informe de Producción", "", "javascript:cambiar_pagina(\'prestaciones/informe_nominas/form.php\');"));
  ...
  if(_cax(205) OR _cax(206) OR _cax(207) OR _cax(208))
      print('addMenuItem(new menuItem("Informes Estadísticos de FAP", "", "javascript:cambiar_pagina(\'prestaciones/consultar_fap/form.php\');"));');
  ...
  print('
      ...
      addMenuItem(new menuItem("Ficha Clínica de Pacientes", "", "javascript:cambiar_pagina(\'prestaciones/episodios_clinicos/form.php\');"));
...
if(_cax(301))
      print('
                addMenuItem(new menuItem("Recaudación de Prestaciones", "", "javascript:cambiar_pagina(\'creditos/ingreso/form.php\');"));
                ...
                addMenuItem(new menuItem("-"));
                addMenuItem(new menuItem("Búsqueda de Pacientes/Créditos", "", "javascript:cambiar_pagina(\'creditos/busqueda/form.php\');"));
                addMenuItem(new menuItem("Listado de Pacientes/Créditos Morosos", "", "javascript:cambiar_pagina(\'creditos/busqueda/form.php?morosidad=1\');"));
        ');
  ...
  addMenuItem(new menuItem("Recepción de Fichas", "", "javascript:cambiar_pagina(\'archivo/entradas/form.php\');"));
  ...
  addMenuItem(new menuItem("Priorización y Autorización de Solicitudes", "", "javascript:cambiar_pagina(\'archivo/estado/form.php\');"));
  ...
  addMenuItem(new menuItem("Asignación de Inventario en Mantención", "", "javascript:cambiar_pagina(\'equipos/asignar_equipos/form.php\');"));
 ...
 if(_cax(105)) {
  ...
  addMenuItem(new menuItem("Administrar Documentación de Ordenes", "", "javascript:cambiar_pagina(\'equipos/listado_mantencion/form.php?modo=admin\');"));
 ...
 print('}');
  ...
  $menu_principal.='addMenuBarItem(new menuBarItem("Administración", menuadmin, "Madmin"));';
  ...
  if(_cax(502) OR _cax(503)){
   ...
   print('
    addMenuItem(new menuItem("Autorizaciones de Fármacos", "", "javascript:cambiar_pagina(\'administracion/autorizacion_farmacos/form.php\');"));
  ...
  addMenuItem(new menuItem("Patologías AUGE", "", "javascript:cambiar_pagina(\'administracion/patologias_auge/form.php\');"));
  ...
  addMenuItem(new menuItem("Garantías de Atención", "", "javascript:cambiar_pagina(\'administracion/garantias_atencion/form.php\');"));
  ...
  addMenuItem(new menuItem("Técnicos", "", "javascript:cambiar_pagina(\'administracion/tecnicos/form.php\');"));

  addMenuItem(new menuItem("Equipos Electromédicos", "", "javascript:cambiar_pagina(\'administracion/clasificacion_equipos/form.php\');"));
  ...
  addMenuItem(new menuItem("Mantención Mod. Pabellón", "", "javascript:cambiar_pagina(\'administracion/mantenedor_pabellon/form.php\');"));
  ...
  addMenuItem(new menuItem("Mantención Espec./Servicios", "", "javascript:cambiar_pagina(\'administracion/mantenedor_especialidades/form.php\');"));
...
<?php
 ...
 /* if(_cax(30)) {
    ...
    print('
      ...
      with (menuestadistica) {
        ...
        addMenuItem(new menuItem("Informes Estadísticos...", "", "javascript:cambiar_pagina(\"estadisticas/form.php\");"));
 ...
 //***********************************************************************************************
  ...
  $menu_principal.='addMenuBarItem(new menuBarItem("Estadísticas", menuestad));';
