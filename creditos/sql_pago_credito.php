<?php 
	...
	$pp=cargar_registro("SELECT* FROM boletines WHERE crecod=$crecod order by bolnum asc limit 1");
	$nboleta=$_POST['nboleta']*1;
	$isapre=$pp['isapre']*1;
	$origen=$pp['origen_id']*1;
	...
	pg_query("UPDATE boletines SET numboleta=$nboleta, isapre=$isapre,origen_id=$origen WHERE bolnum=CURRVAL('boletines_bolnum_seq');");
	...
	$boletin=cargar_registro("SELECT $currval AS bolnum;");		
