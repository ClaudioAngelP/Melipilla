...
seleccionar_inf = function(num, archivo) {
  ...
  'inf_formulario',
  'estadisticas/estadisticas_generales/informes/'+archivo,
  {
    method: 'get',
    evalScripts: true
  });
...
procesar_formulario = function() {
  ...
  myfrm.method='post';
  myfrm.action='estadisticas/estadisticas_generales/informes/'+informe_actual;
...
<b>Estad&iacute;sticas Generales</b>
</div>
