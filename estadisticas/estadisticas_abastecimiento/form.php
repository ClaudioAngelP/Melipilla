...
seleccionar_inf = function(num, archivo) {
  ...
  'inf_formulario',
  'estadisticas/estadisticas_abastecimiento/informes/'+archivo,
  {
    method: 'get',
    evalScripts: true
  });
...
procesar_formulario = function() {
  ...
  myfrm.method='post';
  myfrm.action='estadisticas/estadisticas_abastecimiento/informes/'+informe_actual;
...
<b>Estad&iacute;sticas Abastecimiento/Bodegas</b>
</div>
