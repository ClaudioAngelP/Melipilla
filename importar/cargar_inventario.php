<?php
    ...
    $bod_id=25;
    $fi=explode("\n", utf8_decode(file_get_contents('saldos_abastecimento_16-12-2013.csv')));
    pg_query("START TRANSACTION;");
    pg_query("INSERT INTO logs VALUES (DEFAULT, 7, 20, '18/12/2013 09:53:00', 0, 0, 0, 'Carga inicial realizada masivamente por Sistemas Expertos.' );");
