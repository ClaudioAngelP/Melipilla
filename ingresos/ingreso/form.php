...
?>  
      ...
      $('patrama').innerHTML=s;
		...
		verifica_tabla_inter = function() {
      	...
      	alert('Debe seleccionar Instituciones de Or&iacute;gen y de Destino.'.unescapeHTML());
			...
			if($('sospecha').checked && $('pat_id').value=='') {

				alert('Debe seleccionar Patolog&iacute;a en Sospecha.'.unescapeHTML());
    ...
    <tr>
		...
		<td style='text-align: right;'>Instituci&oacute;n Receptora:</td>
...
<input type='checkbox' id='sospecha' name='sospecha' onClick='
...
<script>
    ...
    autocompletar_especialidades = new AutoComplete(
      ...
      }, 'autocomplete', 350, 100, 150, 2, 3, seleccionar_especialidad);
    ...
    autocompletar_patologias = new AutoComplete(
      ...
      }, 'autocomplete', 400, 100, 150, 2, 3, seleccionar_patologia);
