<?php
  ...
  require_once('../../conectar_db.php');
    ...
    if($tipo_id==0) {
     ...
     $id_sidra=pg_escape_string($_GET['paciente_rut']);
      $rut='';
		} else {
     $id_sidra=0;
      $rut='';
        ...
        $_GET['paciente_fono']));
      $celu=pg_escape_string(iconv("UTF-8", "ISO-8859-1", 
        $_GET['paciente_celu']));
      $mail=pg_escape_string(iconv("UTF-8", "ISO-8859-1", 
        $_GET['paciente_mail']));
