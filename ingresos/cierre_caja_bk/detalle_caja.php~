<?php 
	...
	$l=cargar_registros_obj("
		...
		FROM boletines 
		WHERE bolfec::date = '$fecha' AND $func_w
...
var efectivo=<?php echo json_encode($efectivo); ?>;
...
Monto a Detallar:
</td><td id='montodet' style='font-weight:bold;'>$ <?php echo number_format($efectivo,0,',','.'); ?>.-</td></tr>
