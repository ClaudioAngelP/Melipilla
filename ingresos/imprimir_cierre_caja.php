<?php 
	...
	class PDF extends FPDF {
		function header() {
			...
			$this->SetY(20);	
			$this->Cell(200,7,utf8_decode('DETALLE DE RECAUDACION #'.number_format($ac_id,0,',','.')),0,0,'C');	
	...
	$pdf->Cell(200,7,'Detalle Recaudacion',1,0,'C',1);
    ...
    $pdf->Cell(200,7,utf8_decode('Efectivo'),1,1,'C',1);
