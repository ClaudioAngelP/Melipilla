<?php 
	...
	$pdf->SetFontSize(10);	
	$pdf->SetFont('Arial','');	
	$pdf->Multicell(100,5,utf8_decode(num2texto($total-30000)).' PESOS.',1,'C');
	...
	$pdf->SetFontSize(14);	
	$pdf->SetFont('Arial','B');	
	$pdf->Cell(50,$h,'$ '.number_format($total-30000,0,',','.').'.-',1,0,'C');
	...
	$pdf->SetFontSize(10);	
	$pdf->SetFont('Arial','');	
	$pdf->Multicell(100,5,utf8_decode(num2texto(30000)).' PESOS.',1,'C');
	...
	$pdf->SetFontSize(14);	
	$pdf->SetFont('Arial','B');	
	$pdf->Cell(50,$h,'$ '.number_format(30000,0,',','.').'.-',1,0,'C');
	...
	*/
	...
	if($efe3) {
		...
		$pdf->Cell(45,5,'$'.number_format($total_efectivo-30000,0,',','.').'.-',1,0,'R');
		$pdf->Ln();	
