...
var efectivo=<?php echo json_encode($efectivo+30000); ?>;
...
<tr><td style='text-align:right;'>
Fondo Fijo:
</td><td id='montorec' style='font-weight:bold;color:black;'>$ <?php echo number_format(30000,0,',','.'); ?>.-</td></tr>

<tr><td style='text-align:right;'>
Monto a Rendir:
</td><td id='montorec' style='font-weight:bold;color:blue;'>$ <?php echo number_format($efectivo+30000,0,',','.'); ?>.-</td></tr>
