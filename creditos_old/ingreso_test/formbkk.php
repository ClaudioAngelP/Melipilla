		...
		if( cod.pago_fijo=='t' ) {
			...
			if($('modalidad').value=='mai') {
				...
				if($('frec_id').value*1>0) {
					...
					else if(prev_id==5) valor=cod.precio*1;
					...
					else if(prev_id==5) {  cod2=info_codigo2(codigo, 'mle'); if(cod2!=undefined) { total=cod2.copago_b*1; valor=cod2.copago_c*1; } else { valor=cod.precio*1 }  }
