<?php
  ...
  function desplegar_checks($tabla, $campos, $valsel, 
    ...
    for($i=0;$i<pg_num_rows($opciones);$i++) {
      ...
      <tr><td>
      <input type="checkbox" 
      id="'.$name.'_'.$str_option.'" 
      name="'.$name.'_'.$str_option.'"
  ...
  for($i=0;$i<pg_num_rows($accesos);$i++) {
    ...
    switch($acceso[2]) {
       ...
       break;
        ...
        case 10:
            print('<div class="sub-content2" style="height:130px;font-size:10px;overflow:auto;">
            <table>');
                //print(desplegar_checks('especialidades', 'esp_id, esp_desc', $acceso[4], "esp_padre_id > 0", 'ORDER BY esp_desc', 'acceso_check_'.($acceso[0]*1),$acceso[0],'<font style="font-style:italic;color:#555555;">', 
                print(desplegar_checks('especialidades', 'esp_id, esp_desc', $acceso[4], "true", 'ORDER BY esp_desc', 'acceso_check_'.($acceso[0]*1),$acceso[0], '<font style="font-style:italic;color:#555555;">', '</font>'));
       ...
       case 20:
           ...
           print(desplegar_checks('clasifica_camas', 'tcama_id, tcama_tipo', 
           $acceso[3], 
           "true", 
           'ORDER BY tcama_tipo',
           'acceso_check_'.($acceso[0]*1),$acceso[0]));
       ...
       case 30:
           ...
           print(desplegar_checks('lista_dinamica_bandejas', 'codigo_bandeja, nombre_bandeja', 
           $acceso[4], 
           "true", 
       ...
       case 35:
           ...
           print(desplegar_checks('patologias_auge', 'pat_id, pat_glosa', 
           $acceso[3], 
           "true", 
           'ORDER BY pat_glosa',
           'acceso_check_'.($acceso[0]*1),$acceso[0]));
       ...
       case 36:
           ...
           print(desplegar_checks('autorizacion_farmacos', 'autf_id, autf_nombre', 
           $acceso[3], 
           "true", 
