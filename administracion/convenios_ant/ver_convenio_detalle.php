...
<?php 
	...
	for($i=0;$i<sizeof($d);$i++) {
		...
		print("
			...
			<td><center><img src='../../iconos/magnifier.png' 
				onClick='visualizar_documento(".$d[$i]['doc_id'].");' style='cursor:pointer;' /></center></td>
			</tr>
		");
	...
	<td style='text-align:right;font-weight:bold;'>$".number_format($total*1.19,0,',','.').".-</td>
	<td>&nbsp;</td>
	</tr>");
