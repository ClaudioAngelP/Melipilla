...
<script>
    ...
    cargar_gasto = function(id_gasto)
    {
        ...
        var myAjax = new Ajax.Request('administracion/gastos_ext/cargar_gasto.php',
        {
            method: 'get',
    ...
    mostrar_gasto = function(id_gasto)
    {
        if(id_gasto!=0)
        {
            ...
            $('item_serv').value=gasto.gastoext_item_codigo;
        }
    ...
    calcular_tabla_cc = function()
    {
        ...
        $('gasto_valact').innerHTML=number_format(gasto.totaldet,2)+' '+$('gasto_unidad').value+' ('+pcol+number_format(porcentaje,2)+'%'+pcole+')';
    }
    //******************************************
    ...
    {
        var myAjax = new Ajax.Request('administracion/gastos_ext/sql.php',
        {
            method: 'post',
...
<center>
    <table style='width: 780px; height:535px;'>
        <tr>
            <td>
                <div class='sub-content' style='height:500px;'>
                        ...
                        <table style='width: 100%;'>
                            <tr>
                                <td colspan=2>
                                    ...
                                    <div class='sub-content2' style='height:128px;overflow:auto;' id='listado'>
                            ...
                            <tr>
                                <td style='width: 270px;'>
                                    ...
                                    <div class='sub-content2' style='height:240px;' id='div_datos' name='div_datos'>
                                        <input type='hidden' id='gasto_id' name='gasto_id' value=0>
                                        <input type='hidden' id='item_codigo' name='item_codigo' value=0>
                                        <table width=100%>
                                            <tr>
                                                <td style='text-align: right;'>Nombre:</td>
                                                <td>
                                                    <input type='text' size=20 id='gasto_nombre' name='gasto_nombre' disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type='text' size=10 id='gasto_unidad' name='gasto_unidad' disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style='text-align: right;'>
                                            ...
                                            <tr>
                                                ...
                                                <td style='font-weight: bold;' id='gasto_valact'>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style='text-align: right;'>
                                                ...
                                                <td>
                                                    <input type='text' id='item_serv' name='item_serv' size=20>
                                                </td>
                                            </tr>
                                        </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='#' onClick='guardar_gasto();'>
                                                                Guardar Definici&oacute;n del Gasto...
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='#' onClick='cargar_gasto($("gasto_id").value);'>
                                                                Cancelar Modificaci&oacute;n del Gasto...
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                ...
                                <td>
                                    ...
                                    <div class='sub-content2' style='height:240px;overflow:auto;' id='listado_cc'>
