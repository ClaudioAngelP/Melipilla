<?php 
    ...
    $esp=cargar_registros_obj("SELECT * FROM especialidades where (esp_codigo_ifl_usuario = '' or esp_codigo_ifl_usuario is null) ORDER BY esp_desc", true);
...
<script>
    editar_esp=function(esp_id) {
        ...
        new_win = 
        window.open('administracion/mantenedor_especialidades/editar.php?esp_id='+esp_id,
