	...
	cargar_listado = function() {
		...
		var myAjax = new Ajax.Updater(
			'listado', 
			'administracion/tecnicos/listado_funcionarios.php', 
			{
				method: 'get', 
	...
	seleccionar_usuario = function(idusuario) {
		...
		var myAjax = new Ajax.Request(
			'administracion/tecnicos/bajar_funcionario.php', 
			{
				method: 'get', 
	...
	agregar_usuario = function () {
		...
		func_valor_text.disabled=false;
	...
	editar_usuario = function() {
		...
		$('guardar_texto').innerHTML = 'Guardar Cambios a T&eacute;cnico...';
		$('guardar_boton').style.display='';
	...
	borrar_usuario = function() {
		...
		confirma=confirm('¿Est&aacute; seguro que desea eliminar este t&eacute;cnico? - No hay opciones para deshacer.'.unescapeHTML());
	...
	verifica_tabla = function() {
			...
			var myAjax = new Ajax.Request(
			'administracion/tecnicos/sql.php', 
			{
				method: 'get', 
				  ...
				  datos = pedido_datos.responseText.evalJSON(true);
					...
					if(pedido_datos.responseText=='1') {
						...
						if(func_id_text.value='') {
							alert('Ingreso de t&eacute;cnico realizado exitosamente.'.unescapeHTML());
						} else {
							alert('Edici&oacute;n de t&eacute;cnico realizado exitosamente.'.unescapeHTML());
    ...
    var win = new Window("func_accesos", {className: "alphacube", 
                          ...
                          title: '<img src="iconos/key_go.png"> Accesos del T&eacute;cnico al Sistema',
	...
	<a href='#' onClick='agregar_usuario();'>Agregar T&eacute;cnico...</a>
	</td></tr></table>
	</div>
	...
	<a href='#' onClick='editar_usuario();'>Editar T&eacute;cnico...</a>
	</td></tr></table>
	</div>
	...
	<a href='#' onClick='borrar_usuario();'>Eliminar T&eacute;cnico...</a>
	</td></tr></table>
	</div>
	...
	<a href='#' onClick='permisos_funcionario();'>Permisos T&eacute;cnico...</a>
	</td></tr></table>
	</div>
	...
	<div class='sub-content'><img src='iconos/user_green.png'> <b>Datos del T&eacute;cnico</b></div>
	...
	<tr><td style='text-align: right;'>Valor H.H. ($):</td>		
	<td><input type='text' name='func_valor_hh' id='func_valor_hh' size=10 DISABLED style='text-align:right;'></td></tr>
	...
	<a href='#' onClick='verifica_tabla();'><span id='guardar_texto'>Guardar cambios a Técnico...</span></a>
	</td></tr></table>
	</div>
	</center>
	...
	func_valor_text = document.getElementById('func_valor_hh');
