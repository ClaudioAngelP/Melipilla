...
$convenio_id = $_POST['convenio_id'];
   ...
   <table style='width:80%;'>
	...
	$html="	
		...
		send_mail("claudio.angel@sistemasexpertos.cl,".$convenio['convenio_mails']."",'hfbc@sistemasexpertos.cl',utf8_decode("Ingreso de Nuevo Convenio - $licitacion_conv  ".date('d/m/Y')),$html,$convenio_id);
