...
function ver_multas(convenio_id)  {
	...
	window.open('ver_multas_detalle.php?convenio_id='+convenio_id,
    'win_talonarios');
...
function ver_hitoricos(convenio_id)  {
	...
	window.open('ver_historico_detalle.php?convenio_id='+convenio_id,
    'win_talonarios');
...
<tr>
	...
	<td colspan="3">
		...
		<?php 
			if($c['convenio_tipo_licitacion'] == 1) echo utf8_decode(strtoupper("Apoyo Clínico"));
			if($c['convenio_tipo_licitacion'] == 2) echo utf8_decode(strtoupper("Recursos Físicos"));
			if($c['convenio_tipo_licitacion'] == 3) echo utf8_decode(strtoupper("Prestación de Servicios Clínicos")); 
		 ?>
	</td>
</tr>
<tr>
...
<!--
convenio_aprueba
convenio_nro_res_prorronga
convenio_fecha_prorroga
	-->
<tr>
...
<center><br/><br/><input type='button' value='[ IMPRIMIR CONVENIO ]' onClick='window.print();'><input type='button' value='[ EXPORTAR A EXCEL ]' onClick='exportar_excel();'>
